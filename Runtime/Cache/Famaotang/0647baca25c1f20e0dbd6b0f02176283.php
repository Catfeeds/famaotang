	...
	<body ontouchstart="" style="background-color:#FAFAFA">
		<div class="page">
			<header class="bar bar-nav" style="background-color:#006db2;">
				<a href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/invite');?>" class="icon icon-left pull-left" style="color:#fff"></a>
				<h1 class="title" style="color:#fff">分享给朋友</h1>
			</header>
			<div class="content">
				<div class="kl-layout-center" style="text-align:center; padding-top:10px"></div>
				<div class="content-block" style="margin-top:0.5rem;margin-bottom:0.5rem;">
				    <p  style="text-align:center; margin:20px 0 20px 0"><?php echo ($shareqr_str); ?></p>
					<p>
			...
			<div id="shareit" style="display:none">
  				<img src="/famaotang/Public/<?php echo C('RESOURCE_ROOT_NAME');?>/static/fenxiang.png"  style="width: 242px; height: 180px;float: right;clear: both;">
			</div>
		</div>
	</body>
