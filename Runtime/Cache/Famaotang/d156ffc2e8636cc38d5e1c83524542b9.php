						...
						<ul>
							<?php if($news_type == 2): ?><li>
								<div class="item-content1">
									<div class="item-media1"><?php if($item["news_index"] == 0 and $news_type == 2): ?><img src="/Public/<?php echo C('RESOURCE_ROOT_NAME');?>/static/send_show.png" style="width:2.5rem;height:2.5rem;"><?php else: ?><img src="/Public/<?php echo C('RESOURCE_ROOT_NAME');?>/static/send_show.png" style="width:2.5rem;height:2.5rem; visibility: hidden;"><?php endif; ?></div>
