			...
			<div class="content">
				...
				<div class="kl-layout" style="padding: 0.25rem">
					<div class="center-horizontally">
							...
							<div>
								<div style="text-align: center;font-size:0.5rem;color: red;"><?php echo (number_format($userinfo["dl_fanlitotal"],2,'.','')); ?></div>
								<div style="text-align: center;color:#7e7e7e;font-size:0.6rem;">返利</div>
							</div>
						
						
							<div>
								<div style="text-align: center;font-size:0.5rem;color:#ff9600;"><?php echo (number_format($userinfo["dl_totalmoney_z"],2,'.','')); ?></div>
								<div style="text-align: center;color:#7e7e7e;font-size:0.6rem;">总业绩</div>
							</div>
						
						
							<div>
								<div style="text-align: center;font-size:0.5rem;color:#0068b4;"><?php echo (number_format($userinfo["dl_totalmoney"],2,'.','')); ?></div>
								<div style="text-align: center;color:#7e7e7e;font-size:0.6rem;">当月个人</div>
							</div>
						
						
							<div>
								<div style="text-align: center;font-size:0.5rem;color:#0068b4;"><?php echo (number_format($userinfo["dl_totalmoney_team"],2,'.','')); ?></div>
								<div style="text-align: center;color:#7e7e7e;font-size:0.6rem;">当月团队</div>
							</div>
							
							<div>
								<div style="text-align: center;font-size:0.5rem;color:#0068b4;"><?php echo (number_format($userinfo["dl_totalmoney_team_y"],2,'.','')); ?></div>
								<div style="text-align: center;color:#7e7e7e;font-size:0.6rem;">年度团队</div>
							</div>
				...
				<div class="list-block" style="margin-top:.25rem;margin-bottom: 0rem;">
					...
					<div class="kl-layout" style="padding: 0.25rem">
						<div class="center-horizontally">
							<div id="dlorders_s">
								...
								<div style="text-align: center;color:#7e7e7e;position: relative;">待审<?php if($userinfo["dl_dlsodcount"] > 0): ?><span class="order-circle order-number-thumbnail" style="position: absolute;top:-1.2rem;right:-.3rem; color: red;padding: 0.2rem"><?php echo ($userinfo["dl_dlsodcount"]); ?></span><?php endif; ?></div>
							</div>
							<div id="dlorders_m">
							...
							<div id="myorder_add">
								...
								<div style="text-align: center;color:#7e7e7e;">已发</div>
							</div>
							<div id="mystock_add">
								<i class="iconfont icon-zuixinzhengce" style="font-size:1rem;color:#7e7e7e;line-height:1rem;"></i>
								<div style="text-align: center;color:#7e7e7e;">完成</div>
							</div>
						</div>
					</div>
					<div class="list-block" style="margin-top:.25rem;margin-bottom: 0rem;">
						<ul>
							<li class="item-content item-link">
								...
								<div class="item-inner" id="invite">
									<div class="item-title">
										<h1>邀请代理</h1></div>
							...
							<li class="item-content item-link">
								...
								<div class="item-inner" id="authorization">
									<div class="item-title">
										<h1>授权证书</h1></div>
							...
							<li class="item-content item-link">
								...
								<div class="item-inner" id="updatedltype" >
									<div class="item-title">
										<h1>调级申请</h1></div>
					...
					<div class="list-block" style="margin-top:.25rem;margin-bottom: 0rem;">
						<ul>
						 <li class="item-content item-link">
								<div class="item-media"><i class="iconfont icon-gouwuche" style="font-size:1.2rem; color: #f08519;line-height:1rem;"></i></div>
								<div class="item-inner" id="dinghuo" >
									<div class="item-title">
										<h1>订货</h1></div>
									<div class="item-subtitl" style="color:#c1c1c1;">向上家订货</div>
								</div>
							</li>
							<li class="item-content item-link">
								<div class="item-media"><i class="iconfont icon-dizhi-copy" style="font-size:1.2rem; color: #f08519;line-height:1rem;"></i></div>
								<div class="item-inner" id="dladdress" >
									<div class="item-title">
										<h1>收货地址</h1></div>
							...
							<li class="item-content item-link">
								...
								<div class="item-inner" id="fanli">
									<div class="item-title">
										<h1>我的返利(提现)</h1></div>
									<div class="item-subtitl" style="color:#c1c1c1;">查看我的返利</div>
								</div>
							</li>
					...
					<div class="list-block" style="margin-top:.25rem;margin-bottom: 0rem;">
						<ul>
							<li class="item-content item-link">
								...
								<div class="item-inner" id="feedback" >
							...
							<li class="item-content item-link">
								...
								<div class="item-inner" id="setting" >
									<div class="item-title" style="color: #7e7e7e">
										<h1>设置</h1></div>
								</div>
							</li>
	...
	<script type="text/javascript">
		...
		$(function() {
			$("#dlorders_all").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/home/');?>";
			});
			$("#dlorders_s").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/index/od_state/0/back/1');?>";
			});
			$("#dlorders_m").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/index/od_state/1/back/1');?>";
			});
			$("#myorder_add").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/index/od_state/3/back/1');?>";
			});
			$("#mystock_add").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/index/od_state/8/back/1');?>";
			});
			
			$("#invite").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/invite');?>"
			});
			$("#authorization").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/authorization');?>"
			});
			
			$("#updatedltype").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/updatedltypeindex/up_status/0/back/1');?>"
			});
			$("#dladdress").click(function(){
				 window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/dladdress/');?>"
			});
			$("#fanli").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Fanli');?>"
			});
			$("#capital").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Fanli/capital');?>"
			});
			$("#feedback").click(function(){
				window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Feedback');?>"
			});
			$("#setting").click(function(){
				 window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Mine/setting');?>"
			});
			
			$("#baozhengjin").click(function(){
				 window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Fanli/baozhengjin');?>"
			});

			$("#dinghuo").click(function(){
				 window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Product/index/back/2');?>"
			});

		

			$('#fw_search').click(function() {
				location.href = "<?php echo U('./'.C('MODULE_NAME').'/Query');?>";
			});
		});
	</script>
