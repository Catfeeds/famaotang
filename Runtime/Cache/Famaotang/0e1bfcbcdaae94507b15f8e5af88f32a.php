...
<link rel="stylesheet" type="text/css" href="/famaotang/Public/<?php echo C('RESOURCE_ROOT_NAME');?>/css/demo.css"/>
    ...
    <body ontouchstart="" style="background-color:#FAFAFA">
        <div class="page">
            ...
            <div class="content">
                <form action="<?php echo U('./'.C('MODULE_NAME').'/Orders/uploadpaypic_save');?>"  method="post" id="fmmm" name="fmmm" >
 ...
 <script type="text/javascript" src="/famaotang/Public/<?php echo C('RESOURCE_ROOT_NAME');?>/js/sm.min.js" charset="utf-8"></script>
    ...
    <script type="text/javascript" src="/famaotang/Public/<?php echo C('RESOURCE_ROOT_NAME');?>/js/lrz.all.bundle.js"></script>
         ...
         $(".kl-file").on("change","input[type='file']",function(){
                ...
                // $.toast(filePath);
                 lrz(this.files[0], {width: 800}).then(function (rst) {
                    ...
                    $.showIndicator();
                    $.ajax({
                        url: '<?php echo U('./'.C('MODULE_NAME').'/Orders/uploadpic');?>',
                        type: 'post',
