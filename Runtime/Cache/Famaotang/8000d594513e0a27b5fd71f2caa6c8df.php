		...
		<div class="page">
			...
			<div class="content">
				...
				<div style="background: #fff; margin-top:0.25rem;padding: .5rem">
					 ...
					 <?php if($ordersinfo["od_paypic_str"] != ''): ?><div class="item-input" style="margin: 0.3rem 0" id="big_pic"><img   class="kl-img-thumbnail" id="img_file" src="<?php echo ($ordersinfo["od_paypic_str"]); ?>" style="width:4rem;margin-top:.2rem;"></div>
						 <div class="item-input" style="margin: 0.3rem 0;display: none;" id="big_pic2"><img   class="kl-img-thumbnail" id="img_file" src="<?php echo ($ordersinfo["od_paypic_str"]); ?>" style="width:100rem;height:rem;margin-top:.2rem;"></div><?php endif; ?>
