	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#dl_updateapply').click(function() {
				location.href = "<?php echo U('./'.C('MODULE_NAME').'/Dealer/updatedltype');?>";
			});
                ...
                $(this).click(function(){
                    if ($.isArray(dlArray)&&dlArray.length>index)
                    {
                        ...
                        if ($.isPlainObject(dlObject))
                        {
                            ...
                            window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/updatedltypedetail2/apply_id');?>/"+dlObject['apply_id'];
                        }
                    }
                });
            });
            ...
            $('.item-content.item-link.my_update_item').each(function(index) {
                ...
                $(this).click(function(){
                    if ($.isArray(myArray)&&myArray.length>index)
                    {
                        ...
                        {
                            // console.log(dlmObject['dl_id']);
                            window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/updatedltypedetail/apply_id');?>/"+myObject['apply_id'];
                        }
                    }
                });
            });
