  ...
  <body ontouchstart="" style="background-color:#FAFAFA">
    <div class="page">
      <header class="bar bar-nav" style="background-color:#006db2;">
		...
		<a href="<?php echo U('./'.C('MODULE_NAME').'/Orders/dlorders/od_state/'.$ordersinfo['od_state'].'');?>" class="icon icon-left pull-left" style="color:#fff"></a>
                    ...
                    <div class="order-inner">
                      ...
                      <div class="order-remark">
                        <div class="kl-layout-horizontally-between">
                          ...
                          <?php if(($item["oddt_shipment"] == 1)): ?><i class="iconfont icon-saoyisao all_odsaomian" style="font-size: 2rem;color: #167abe;"></i><?php endif; ?>
                        </div>
                      </div>
  ...
  <script type="text/javascript">
    ...
    $(function() {
        ...
        $("#dtl_odqueren").click(function(){
            if (od_id>0)
              window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/canceldlorder/od_id');?>/"+od_id+"/state/1/od_state/"+od_state;
          });
        $("#dtl_odcancel").click(function(){
            if (od_id>0){
                $.confirm('是否确定取消该订单吗?',function () {
					 window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/canceldlorder/od_id');?>/"+od_id+"/state/9/od_state/"+od_state;
				});
        ...
        $("#dtl_finish").click(function(){
            if (od_id>0)
            window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Orders/odfinishship/od_id');?>/"+od_id+"/state/9/od_state/"+od_state;
        });
