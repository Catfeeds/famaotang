            ...
            <div class="content">
                 <div class="list-block" style="margin: 0.3rem 0;">
                    <ul>
					  ...
					  <?php if(($recashinfo["rc_bankname"] != '' )): ?><li>
                        <div class="item-content">
                          <div class="item-inner">
                            <div class="item-title">开户支行：<?php echo ($recashinfo["rc_bankname"]); ?></div>
                          </div>
                        </div>
                      </li><?php endif; ?>
                      ...
                      <li>
                         <div class="item-content">
                          <div class="item-inner">
                            <div class="item-title">提现金额：<?php echo ($recashinfo["rc_moneystr"]); ?> 元</div>
                          </div>
                        </div>
                      </li>
					  <?php if($recashinfo["rc_shouxufeistr"] != '' and $recashinfo["rc_shouxufeistr"] > 0 ): ?><li>
                         <div class="item-content">
                          <div class="item-inner">
                            <div class="item-title">手续费：<?php echo ($recashinfo["rc_shouxufeistr"]); ?> 元</div>
                          </div>
                        </div>
                      </li>
					   ...
					   <li>
                         <div class="item-content">
                          <div class="item-inner">
                            <div class="item-title">实收金额：<?php echo ($recashinfo["rc_shishoumoneystr"]); ?> 元</div>
                          </div>
                        </div>
                      </li><?php endif; ?>
                       <li>
