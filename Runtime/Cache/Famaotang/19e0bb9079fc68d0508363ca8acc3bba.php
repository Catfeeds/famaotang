    ...
    <body ontouchstart="" style="background-color:#FAFAFA">
        <div class="page">
            <header class="bar bar-nav" style="background-color:#006db2;">
                ...
                <a href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/updatedltypeindex/');?>/up_status/<?php echo ($up_status); ?>" class="icon icon-left pull-left" style="color:#fff"></a>
                                ...
                                <div class="item-content">
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="item-input">
										   ...
										   <?php echo ($updateinfo["apply_pic_str"]); ?>
                                        </div>
                                    </div>
                                </div>
                            </li>
