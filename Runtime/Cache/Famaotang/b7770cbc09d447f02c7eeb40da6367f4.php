                            ...
                            <li>
                                <div class="item-content">
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <img class="kl-circle kl-img-thumbnail" src="/Public/uploads/mobi/<?php echo ($dlinfo["dl_wxheadimg"]); ?>" style="width:2.5rem; border-radius: 50%;" onerror="this.src='/Public/<?php echo C('RESOURCE_ROOT_NAME');?>/static/head_icon.png'">
                                    </div>
                                </div>
                            </li>
                            <li>
    ...
    $(function() {
        ...
        $("#dl_delete").click(function() {
            $.confirm('确定删除该代理吗?', function () {
                // $.toast("确定删除");
                window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/applydelete/dlid');?>/"+dl_id;
            });
        });
        $("#dl_confirm").click(function() {
              $.confirm('确定通过该代理吗?', function () {
                // $.toast("确定通过");
                window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/applyactive/dlid');?>/"+dl_id;
            });
        });
    });
    </script>   
