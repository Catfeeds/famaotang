...
<link rel="stylesheet" type="text/css" href="/Public/<?php echo C('RESOURCE_ROOT_NAME');?>/css/demo.css"/>
    ...
    <body ontouchstart="" style="background-color:#FAFAFA">
        <div class="page">
            ...
            <div class="content">
                <form action="<?php echo U('./'.C('MODULE_NAME').'/Dealer/qyjxapply');?>" method="post" id="fmmm" name="fmmm">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("#dealer_sumbit").click(function(){
                ...
                window.location.href="<?php echo U('./'.C('MODULE_NAME').'/Dealer/qyshare');?>"+"/dltid/"+dlt_id+"/ttamp/<?php echo ($ttamp); ?>/sture/<?php echo ($sture); ?>";
            });
        });
    </script>
</html>