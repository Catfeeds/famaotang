    ...
    <body ontouchstart="" style="background-color:#FAFAFA">
        <div class="page">
            <header class="bar bar-nav" style="background-color:#006db2;">
                <a href="<?php echo U('./'.C('MODULE_NAME').'/Mine');?>" class="icon icon-left pull-left" style="color:#fff"></a>
                        ...
                        <div id="tab1" class="tab active">
                            <div class="content-block" style="min-height: 10rem;">
                                ...
                                <div class="list-block" style="margin-top:.25rem;margin-bottom: 0rem;">
                                    <ul>
                                        <li class="item-content item-link btn" id="receivelist">
                                        ...
                                        <li class="item-content item-link btn" id="paylist">
                                ...
                                <div class="list-block" style="margin-top:.25rem;margin-bottom: 0rem;">
                                    <ul>
                                        <li class="item-content item-link btn "  id="recashlist" >
                                                ...
                                                <div class="list-block media-list" style="margin-top:0rem;">
                                                    <ul>
                                                        <?php if(is_array($list)): foreach($list as $key=>$item): ?><li class="fanli_item_ds">
                                                                <a href="<?php echo U('./'.C('MODULE_NAME').'/Fanli/fanlidetail/fl_id');?>/<?php echo ($item["fl_id"]); ?>/state/<?php echo ($state); ?>/ly_status/1" class="item-link item-content">
                                                                     <div class="item-inner">
    ...
    $(function() {
            // $("#dl_tuijian").click();
                    ...
                    $("#fanli_ds").click(function(){
                        // $.toast('待收');
                        window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/index/state/0/ly_status/1');?>";
                    });

                    $("#fanli_ys").click(function(){
                        window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/index/state/1/ly_status/1');?>";
                    });

                    $("#fanli_df").click(function(){
                         window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/index/state/2/ly_status/1');?>";
                    });

                    $("#fanli_yf").click(function(){
                        window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/index/state/3/ly_status/1');?>";
                    });

                    $("#fanli_qx").click(function(){
                         window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/index/state/9/ly_status/1');?>";
                    });
					
					
					
					$("#receivelist").click(function(){
                         window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/receivelist');?>";
                    });
					
					$("#paylist").click(function(){
                         window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/paylist');?>";
                    });
					
					$("#salemonthly").click(function(){
                         window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/salemonthly/yj_type/0');?>";
                    });
					
					$("#recashlist").click(function(){
                         window.location.href ="<?php echo U('./'.C('MODULE_NAME').'/Fanli/recashlist');?>";
                    });
