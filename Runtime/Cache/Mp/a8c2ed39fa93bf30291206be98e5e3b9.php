...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">返利明细</A></div>
...
<form action="<?php echo U('Mp/Fanli/fanlilist');?>"   method="post" name="fmmm"  >
...
<td class="data"><span><?php if(($item["fl_orderid"] != '') AND ($item["fl_orderid"] != '0') ): ?><a href="<?php echo U('Mp/Orders/orderdetail?od_id='.$item['fl_odid'].'&odbl_id='.$item['fl_odblid'].'');?>"  ><?php echo ($item["fl_orderid"]); ?></a><?php endif; ?></span></td>
<td class="data"><span><?php echo ($item["fl_remark"]); ?></span></td>
<td class="data"><span><?php echo ($item["fl_state_str"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Fanli/fanlidetail?fl_id='.$item['fl_id'].'');?>">详细</a></span></td>
