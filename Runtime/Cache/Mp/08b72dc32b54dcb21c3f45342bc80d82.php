...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">礼品管理</A></div>
<div class="nav_r"><a href="<?php echo U('Mp/Dljf/dljfgift_add');?>">添加礼品</a></div>
</div>
...
<th  width="28%"   style="text-align:left"><span>礼品名称</span></th>
<th  width="9%" ><span>所需积分</span></th>
<th  width="9%" ><span>未兑数量</span></th>
<th  width="9%" ><span>已兑数量</span></th>
<th  width="15%"  ><span>添加时间</span></th>
...
<td class="data"><span><?php echo ($item["gif_pic_str"]); ?></span></td>
<td class="data" style="text-align:left" ><span><?php echo ($item["gif_name"]); ?></span></td>
<td class="data"><span><?php echo ($item["gif_jf"]); ?></span></td>
<td class="data"><span><?php echo ($item["gif_qty"]); ?></span></td>
<td class="data"><span><?php echo ($item["gif_qty2"]); ?></span></td>
<td class="data"><span><?php echo (date('Y-m-d H:m:s',$item["gif_addtime"])); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Dljf/dljfgift_active?gif_id='.$item['gif_id'].'&gif_active='.$item['gif_active'].'');?>" ><img src="/Public/mp/static/<?php echo ($item['gif_active'] == 0?'no':'yes'); ?>.gif" /></a></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Dljf/dljfgift_edit?gif_id='.$item['gif_id'].'');?>">修改</a>　<a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Dljf/dljfgift_delete?gif_id='.$item['gif_id'].'');?>';" >删除</a></span></td>
