...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">生成年销售奖</A></div>
...
<div class="height10"></div>
<div class="content">
<form action="<?php echo U('Mp/Fanli/make_salemonthly2');?>"   method="post" name="fmmm"  >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >选择年份：</td>
				  <td class="txtleft" >
				  <select name="yearmonth"   class="select"   >
					<option value="0" >选择年份　</option>
					<?php if(is_array($nyearmontharr)): foreach($nyearmontharr as $key=>$item): ?><option value="<?php echo ($item); ?>"  ><?php echo (date('Y',$item)); ?>　</option><?php endforeach; endif; ?>
                  </select>
				  </td>
			  </tr>
			  ...
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="生成年销售奖" class="botton" >　　　　<input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
            </td>
			  </tr>
			</table>
</form>
