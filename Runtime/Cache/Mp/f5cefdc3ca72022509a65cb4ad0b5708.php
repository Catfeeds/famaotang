...
<div class="nav_r"><!--<?php if(($qypurview["99999"]) == "99999"): ?><a href="<?php echo U('Mp/Dealer/typeadd');?>">添加级别</a><?php endif; ?>--></div>
</div>
<div class="height20"></div>
<div class="content">
<table class="table_results" >
<thead><tr>
<th  width="50%"  style="text-align:left" ><span>经销商级别名称</span></th>
<th  width="10%" ><span>级别</span></th>
<th  width="20%"  ><span>经销商数量</span></th>
...
<td class="data"  ><span><?php echo ($item["dlt_level"]); ?></span></td>
<td class="data"  ><span><?php echo ($item["dcount"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Dealer/typeview?dlt_id='.$item['dlt_id'].'');?>">详细</a><?php if(($qypurview["99999"]) == "99999"): ?>　<a href="<?php echo U('Mp/Dealer/typeedit?dlt_id='.$item['dlt_id'].'');?>">修改</a>　<a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Dealer/dltdel?dlt_id='.$item['dlt_id'].'');?>';" >删除</a><?php endif; ?></span></td>
