...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">防伪码查询记录</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:40%">
<form action="<?php echo U('Mp/Chaxun/fwlist');?>"   method="post" name="fmmm"  >
防伪码：<input    type="text" size="20" maxlength="25"  name="keyword"  class="input"  value="<?php echo ($keyword); ?>"   >   <input type="submit" name="Submit" value="搜 索"  ></form>
</div>
...
<select name="statu"  ID="statu" style="width:100px">
<option value=0   <?php if(($statu) == "0"): ?>selected<?php endif; ?> >全部</option>	
<option value="1" <?php if(($statu) == "1"): ?>selected<?php endif; ?> >首次</option>
<option value="2" <?php if(($statu) == "2"): ?>selected<?php endif; ?> >重复</option>
</select>　
...
<thead><tr>
<th  width="25%" ><span>防伪码</span></th>
<th  width="10%" ><span>查询状态</span></th>
<th  width="20%" ><span>查询时间</span></th>
<th  width="10%" ><span>查询方式</span></th>
<th  width="20%" ><span>查询来源</span></th>
<th  width="15%"  ><span>备注</span></th>

</tr></thead>
<tbody>
<?php if(is_array($list)): foreach($list as $key=>$item): ?><tr class="<?php echo ($key%2 == 0?'odd':'even'); ?>" >
<td class="data"><span><?php echo ($item["fwcode"]); ?></span></td>
<td class="data"><span><?php echo ($item["querystatu"]); ?></span></td>
<td class="data"><span><?php echo ($item["querydate"]); ?></span></td>
<td class="data"><span><?php echo ($item["qutypestr"]); ?></span></td>
<td class="data"><span><?php echo ($item["callerid"]); ?></span></td>
<td class="data"><span><?php echo ($item["remark"]); ?></span></td>
