...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Fanli/paylist');?>">我应付返利</A>　&gt;　<A href="#">提现处理</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Fanli/recashdeal_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data"  >
<input type="hidden" value="<?php echo ($recashinfo["rc_id"]); ?>" name="rc_id" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"  class="txtright" >提现代理：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["dl_name_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >付款代理：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["dl_sendname_str"]); ?></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >开户银行：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["rc_bankstr"]); ?></td>
			  </tr>
			   <?php if($recashinfo["rc_bankname"] != '' ): ?><tr>     
                  <td height="40"  class="txtright" >开户支行：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["rc_bankname"]); ?></td>
			  </tr><?php endif; ?>
			  <tr>     
                  <td height="40"  class="txtright" >卡号/账号：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["rc_bankcardstr"]); ?></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >卡号/账号姓名：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["rc_name"]); ?></td>
			  </tr>

			   <tr>     
                  <td height="40"  class="txtright" >提取金额：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["rc_moneystr"]); ?> 元</td>
			  </tr>
			  
              <tr>     
                  <td height="40"  class="txtright" >手续费：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["rc_shouxufeistr"]); ?> 元</td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >实付金额：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["rc_shishoumoneystr"]); ?> 元</td>
			  </tr>
			  
              <tr>     
                  <td height="40"  class="txtright" >申请时间：</td>
				  <td  class="txtleft" ><?php echo (date('Y-m-d H:i:s',$recashinfo["rc_addtime"])); ?></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >当前状态：</td>
				  <td  class="txtleft" ><?php echo ($recashinfo["rc_statestr"]); ?></td>
			  </tr>
<?php if(($recashinfo["rc_state"]) == "0"): ?><tr>     
                  <td height="40"  class="txtright" >凭证：</td>
				  <td  class="txtleft" >
				  <?php if(($recashinfo["rc_pic_str"]) != ""): ?><a href="/Public/uploads/orders/<?php echo ($recashinfo["rc_pic"]); ?>" target="_blank" ><?php echo ($recashinfo["rc_pic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" />  <input type="hidden"  value="<?php echo ($recashinfo["rc_pic"]); ?>" name="old_rc_pic" />
				  </td>
			  </tr>
			  ...
			  <tr>     
                  <td height="40"  class="txtright" >处理状态：</td>
				  <td  class="txtleft" >
				  <select name="rc_state"   class="select"   >
					<option value="0" selected >状态更改为　</option>
			   ...
			   <tr>     
                  <td height="40"  class="txtright"  >处理备注：</td>
			     <td  class="txtleft" ><br><br><textarea  name="rc_remark"   rows="4"  cols="40" ><?php echo ($recashinfo["rc_remark"]); ?></textarea><br><br></td>
			  </tr>

			  
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="确认处理" class="botton" >　　　　<input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
            </td>
			</tr>
			 <tr>     
                  <td height="40"  class="txtright" ></td>
				  <td  class="txtleft" >注：每个提现记录只能处理一次，确认处理后不能再修改，请谨慎处理</td>
			  </tr><?php endif; ?>
			</table>
</form>
</div>
