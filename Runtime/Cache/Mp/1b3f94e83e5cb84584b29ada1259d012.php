...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">经销商出货记录</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:30%">
<form action="<?php echo U('Mp/Shipment/dlshiplist');?>"   method="post" name="fmmm"  >
<input    type="text" size="25" maxlength="25"  name="keyword"  class="input"   onfocus="this.value=''"   value="输入条码、出货单号"   style="color:#999999"  >   <input type="submit" name="Submit" value="搜 索"  ></form>
</div>
...
<th  width="8%"  ><span>产品编号</span></th>
<th  width="16%"  ><span>产品名称</span></th>
<th  width="8%"  ><span>出货日期</span></th>
<th  width="10%"  ><span>出货代理</span></th>
...
<td class="data" ><span><?php echo ($vo["dl_name_send"]); ?></span></td>
