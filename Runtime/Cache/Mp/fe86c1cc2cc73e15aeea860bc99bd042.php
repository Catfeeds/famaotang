...
<script type="text/javascript" language="javascript">
        $(document).ready(function() {
            $("#verifyImg").click(function(){
				$("#verifyImg").attr("src","<?php echo U('Mp/Login/verify');?>?"+ Math.random());
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td><input    type="text" size="4" maxlength="4"  name="checkcode"  class="input"  value=""  id="checkcode"    > <img  alt="点击换另一个" title="点击换另一个"  style="vertical-align:middle; cursor:pointer"  id="verifyImg" src="<?php echo U('Mp/Login/verify');?>"  /></td>
  </tr>
  <tr>
    <td height="50"  >&nbsp;</td>
