...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Fanli/fanlilist');?>">返利明细</A>　&gt;　<A href="#">返利详细</A></div>
<div class="nav_r"></div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
             <tr>     
			   ...
			   <tr>     
                  <td height="40"  class="txtright" >返利类型：</td>
				  <td  class="txtleft" ><?php echo ($fanliinfo["fl_typestr"]); ?></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >收款代理：</td>
				  <td  class="txtleft" ><?php echo ($fanliinfo["fl_dl_name"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >付款代理：</td>
				  <td  class="txtleft" ><?php echo ($fanliinfo["dl_sendname_str"]); ?></td>
			  </tr>

			   <tr>     
                  <td height="40"  class="txtright" >金额：</td>
				  <td  class="txtleft" ><?php echo ($fanliinfo["fl_moneystr"]); ?> 元</td>
			  </tr>
			    <tr>     
                  <td height="40"  class="txtright" >手续费：</td>
				  <td  class="txtleft" ><?php echo ($fanliinfo["fl_shouxufeistr"]); ?> 元</td>
			  </tr>
			    <tr>     
                  <td height="40"  class="txtright" >实际金额：</td>
				  <td  class="txtleft" ><?php echo ($fanliinfo["fl_shijimoneystr"]); ?> 元</td>
			  </tr>
			  <?php if(($fanliinfo["fl_orderid"] != '') AND ($fanliinfo["fl_orderid"] != '0') ): ?><tr>     
                  <td height="40"  class="txtright" >相关订单号：</td>
				  <td  class="txtleft" ><?php echo ($fanliinfo["fl_orderid"]); ?></td>
			  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright"  >说明：</td>
			     <td  class="txtleft" ><?php echo ($fanliinfo["fl_remark"]); ?></td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >时间：</td>
				  <td  class="txtleft" ><?php echo (date('Y-m-d H:i:s',$fanliinfo["fl_addtime"])); ?></td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >状态：</td>
				  <td  class="txtleft" ><?php echo ($fanliinfo["fl_state_str"]); ?></td>
			  </tr>
			  <?php if($fanliinfo["fl_rcid"] > '0' ): ?><tr>     
                  <td height="40"  class="txtright" >对应提现记录：</td>
				  <td  class="txtleft" ><A href="<?php echo U('Mp/Fanli/recashdetail?rc_id='.$fanliinfo['fl_rcid'].'');?>" >查看</a></td>
			  </tr><?php endif; ?>
