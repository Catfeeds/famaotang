...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">预付款明细</A></div>
...
<form action="<?php echo U('Mp/Capital/yufukuan');?>"   method="post" name="fmmm"  >
...
<td class="data"><span><?php echo ($item["yfk_typestr"]); ?></span></td>
<td class="data"><span><?php echo ($item["yfk_moneystr"]); ?></span></td>
<td class="data"><span><?php echo (date('Y-m-d H:i:s',$item["yfk_addtime"])); ?></span></td>
<td class="data"><span><?php if(($item["yfk_orderid"] != '') AND ($item["yfk_orderid"] != '0') ): ?><a href="<?php echo U('Mp/Orders/orderdetail?od_id='.$item['yfk_odid'].'&odbl_id='.$item['yfk_odblid'].'');?>"  ><?php echo ($item["yfk_orderid"]); ?></a><?php endif; ?></span></td>
<td class="data"><span><?php echo ($item["yfk_remark"]); ?></span></td>
<td class="data"><span><?php echo ($item["yfk_state_str"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Capital/yfkdetail?yfk_id='.$item['yfk_id'].'');?>">详细</a></span></td>
