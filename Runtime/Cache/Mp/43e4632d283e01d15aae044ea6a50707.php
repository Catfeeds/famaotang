...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">代理返利</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:40%">
<form action="<?php echo U('Mp/Fanli/index');?>"   method="post" name="fmmm"  >
...
<select name="dl_status"   class="select"   onChange="document.location.href ='<?php echo U('Mp/Fanli/index');?>?dl_type=<?php echo ($dl_type); ?>&dl_status='+this.value;" >
...
　
<select name="dl_type"   class="select" style="width:140px" onChange="document.location.href ='<?php echo U('Mp/Fanli/index');?>?dl_status=<?php echo ($dl_status); ?>&dl_type='+this.value;" >
...
<thead><tr>
<th  width="16%" style="text-align:left"><span>经销商名称</span></th>
<th  width="10%"   ><span>经销商编号</span></th>
<th  width="10%" ><span>电话</span></th>
<th  width="10%" ><span>级别</span></th>
<th  width="12%" ><span>上家代理</span></th>
<th  width="12%"  ><span>推荐人</span></th>
<th  width="10%"  ><span>待收返利</span></th>
<th  width="10%"  ><span>待付返利</span></th>
...
<td class="data"><span><?php echo (number_format($item["dl_rcsum"],2,'.','')); ?> 元</span></td>
<td class="data"><span><?php echo (number_format($item["dl_sendsum"],2,'.','')); ?> 元</span></td>
<td class="data"><span><a href="<?php echo U('Mp/Fanli/fanlidldetail?dl_id='.$item['dl_id'].'');?>">详细</a>　<a href="<?php echo U('Mp/Fanli/fanlilist?dlusername='.$item['dl_username'].'');?>">明细</a></span></td>
