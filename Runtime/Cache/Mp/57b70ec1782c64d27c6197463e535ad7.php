...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Orders/index');?>">订单管理</A>　&gt;　<A href="#">所有订单</A></div>
<div class="nav_r"><a href="javascript:window.history.go(-1);" >&lt;&lt; 返 回</a></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:30%">
<form action="<?php echo U('Mp/Orders/index');?>"   method="post" name="fmmm"  >
...
<select name="od_state"   class="select" >
					...
					<option value="1" <?php if($od_state == '1' ): ?>selected<?php endif; ?>  >待发货</option>
...
　<?php echo ($item2["oddt_proname"]); ?>  (<?php echo ($item2["oddt_pronumber"]); ?>) <?php if($item2["oddt_color"] != '' ): echo ($item2["oddt_color"]); endif; ?>　<?php if($item2["oddt_size"] != '' ): echo ($item2["oddt_size"]); endif; ?> </span></td>
...
<td class="data"  rowspan="<?php echo ($item["countdetail"]); ?>" ><span><?php echo ($item["caozuostr"]); ?></span></td><?php endif; ?>
