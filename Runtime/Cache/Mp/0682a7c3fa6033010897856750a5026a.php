...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">充值记录</A></div>
<div class="nav_r"></div>
</div>
...
<thead><tr>
<th  width="16%" style="text-align:left"><span>充值代理</span></th>
<th  width="10%"   ><span>充值金额</span></th>
<th  width="12%" ><span>申请时间</span></th>
<th  width="15%" ><span>申请备注</span></th>
<th  width="12%" ><span>处理时间</span></th>
<th  width="15%"  ><span>处理备注</span></th>
...
<td class="data" ><span><?php echo ($item["pi_moneystr"]); ?></span></td>
<td class="data"><span><?php echo (date('Y-m-d H:i:s',$item["pi_addtime"])); ?></span></td>
<td class="data"><span><?php echo ($item["pi_remark"]); ?></span></td>
<td class="data"><span><?php if(($item["pi_dealtime"] != '') AND ($item["pi_dealtime"] != '0') ): echo (date('Y-m-d H:i:s',$item["pi_dealtime"])); endif; ?></span></td>
<td class="data"><span><?php echo (nl2br($item["pi_dealremark"])); ?></span></td>
<td class="data"><span><?php echo ($item["pi_statestr"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Capital/payindetail?pi_id='.$item['pi_id'].'');?>">详细</a><?php if($item["pi_state"] == '0' ): ?>　<a href="<?php echo U('Mp/Capital/payindeal?pi_id='.$item['pi_id'].'');?>">处理</a><?php endif; ?></span></td>
