...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Product/typelist');?>">产品分类管理</A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Product/typeedit_save');?>"   method="post" name="fmmm" >
<input type="hidden" value="<?php echo ($protypeinfo["protype_id"]); ?>" name="protype_id" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >分类名称：</td>
				  <td class="txtleft" ><input    type="text" size="25" maxlength="25"  name="protype_name"  class="input"  value="<?php echo ($protypeinfo["protype_name"]); ?>"   >  * </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >选择父类：</td>
				  <td  class="txtleft" >
				  <select name="protype_iswho" id="protype_iswho"  class="select" >
					<option value="0"   >选择父类</option>
					<?php if(is_array($parenttypelist)): foreach($parenttypelist as $key=>$item): ?><option value="<?php echo ($item["protype_id"]); ?>"  <?php echo ($item["selected"]); ?> ><?php echo ($item["protype_name"]); ?></option><?php endforeach; endif; ?>
				  </select>
		      </td>
			  </tr>
