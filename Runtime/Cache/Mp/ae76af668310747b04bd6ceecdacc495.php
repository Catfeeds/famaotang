...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dealer/index');?>">经销商管理</A>　&gt;　<A href="<?php echo U('Mp/Dealer/updatedltypelist');?>">调级申请</A>　&gt;　<A href="#">调级申请记录详细</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">

<form action="<?php echo U('Mp/Dealer/updatedltypedeal');?>"   method="post" name="fmmm"  >
<input type="hidden" value="<?php echo ($updateinfo["apply_id"]); ?>" name="apply_id" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >申请代理：</td>
				  <td class="txtleft" ><?php echo ($updateinfo["dl_name_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >申请前上家：</td>
				  <td  class="txtleft" ><?php echo ($updateinfo["apply_agobelong_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >申请前级别：</td>
				  <td  class="txtleft" ><?php echo ($updateinfo["apply_agodltype_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >申请后上家：</td>
				  <td  class="txtleft" ><?php echo ($updateinfo["apply_afterbelong_str"]); ?></td>
			  </tr>
			  
			   <tr>  
                  <td height="40"  class="txtright" >申请后级别：</td>
				  <td  class="txtleft" ><?php echo ($updateinfo["apply_afterdltype_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >凭证：</td>
				  <td  class="txtleft" ><?php echo ($updateinfo["apply_pic_str"]); ?></td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >当前状态：</td>
				  <td  class="txtleft" ><?php echo ($updateinfo["apply_state_str"]); ?></td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >申请时间：</td>
				  <td  class="txtleft" ><?php echo (date('Y-m-d H:m:s',$updateinfo["apply_addtime"])); ?></td>
			  </tr>
			  <?php if(($updateinfo["apply_dealtime"] != '') AND ($updateinfo["apply_dealtime"] != '0') ): ?><tr>     
                  <td height="40"  class="txtright" >处理时间：</td>
				  <td  class="txtleft" ><?php echo (date('Y-m-d H:m:s',$updateinfo["apply_dealtime"])); ?></td>
			  </tr><?php endif; ?>
			 
              <?php if($updateinfo["apply_remark"] != '' ): ?><tr>     
                  <td height="40"  class="txtright" >处理备注：</td>
				  <td  class="txtleft" ><?php echo (nl2br($updateinfo["apply_remark"])); ?></td>
			  </tr><?php endif; ?>
...
<?php if(($updateinfo["apply_state"]) == "0"): ?><tr>     
                  <td height="40"  class="txtright" >处理动作：</td>
				  <td  class="txtleft" >
				  <select id="apply_state" name="apply_state"  class="input"  >
				  <option  value="" selected >选择处理结果 </option>
				  <option value="1" >确认调整级别</option>
				  <option value="2" >申请无效</option>
				  </select>
				   </td>
			  </tr>
              ...
              <tr>     
                  <td height="40"  class="txtright" >处理备注：</td>
			     <td  class="txtleft" ><textarea cols="50" rows="3" name="apply_remark"  id="apply_remark" ></textarea></td>
			  </tr>
              <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="确认处理" class="botton" >
            </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" ></td>
				  <td  class="txtleft" >注：每个调级记录只能处理一次，确认处理完后不能再操作</td>
			  </tr><?php endif; ?>
