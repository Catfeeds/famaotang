...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">价格体系</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<form action="<?php echo U('Mp/Product/proprice');?>"   method="post" name="fmmm"  >
...
<thead><tr>
<th  width="20%" style="text-align:left" ><span>产品名称</span></th>
<th  ><span>零售价</span></th>
<?php if(is_array($typelist)): foreach($typelist as $key=>$item): ?><th ><span><?php echo ($item["dlt_name"]); ?></span></th><?php endforeach; endif; ?>
...
<td class="data" style="text-align:left" ><span><?php echo ($item["pro_name"]); ?> <?php echo ($item["pro_number"]); ?></span></td>
...
<td class="data"><span><img src="/famaotang/Public/mp/static/<?php echo ($item['pro_active'] == 0?'no':'yes'); ?>.gif" /></span></td>
