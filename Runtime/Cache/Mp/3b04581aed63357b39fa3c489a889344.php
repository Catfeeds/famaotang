...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Jfmobi/piclist');?>">图片管理</A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Jfmobi/pic_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data" >
<input type="hidden" value="<?php echo ($jfmopicsinfo["pics_id"]); ?>" name="pics_id" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >图片说明：</td>
				  <td class="txtleft" ><input    type="text" size="25" maxlength="50"  name="pics_title"  class="input"  value="<?php echo ($jfmopicsinfo["pics_title"]); ?>"   >  </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >选择图片：</td>
				  <td  class="txtleft" >
				  <?php if(($jfmopicsinfo["pics_name_str"]) != ""): echo ($jfmopicsinfo["pics_name_str"]); endif; ?> <input name="pic_file" type="file" /> (建议图片宽度小于640px,文件小于300k)
				  </td>
			  </tr>
