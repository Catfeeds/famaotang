...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Fanli/recashlist');?>">返利提现</A>　&gt;　<A href="#">提现详细</A></div>
<div class="nav_r"></div>
</div>
             ...
             <tr>     
			  ...
			  <tr>     
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" ><?php echo ($recashinfo["dl_payname_str"]); ?></td>
			  </tr>
			  <tr>     
			  ...
			  <tr>     
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" >
				  <?php if(($recashinfo["rc_pic_str"]) != ""): ?><a href="/Public/uploads/orders/<?php echo ($recashinfo["rc_pic"]); ?>" target="_blank" ><?php echo ($recashinfo["rc_pic_str"]); ?></a><?php endif; ?> 
				  </td>
			  </tr>
			  
			  <tr>     
                  <td height="40"  class="txtright" >处理时间：</td>
				  <td  class="txtleft" ><?php if(($recashinfo["rc_dealtime"] != '') AND ($recashinfo["rc_dealtime"] != '0') ): echo (date('Y-m-d H:i:s',$recashinfo["rc_dealtime"])); endif; ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright"  >处理备注：</td>
			     <td  class="txtleft" ><?php echo (nl2br($recashinfo["rc_remark"])); ?><br></td>
			  </tr>
			  ...
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
			 <?php if($back == '1' ): ?><a href="<?php echo U('Mp/Fanli/paylist');?>" class="abotton" >&lt;&lt; 返 回</a><?php else: ?><a href="javascript:window.history.go(-1);" class="abotton" >&lt;&lt; 返 回</a><?php endif; ?>
            </td>
