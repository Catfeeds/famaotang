...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Warehouse/index');?>">仓库管理</A>　&gt;　<A href="#">仓库列表</A></div>
<div class="nav_r"><?php if(($qypurview["11002"]) == "11002"): ?><a href="<?php echo U('Mp/Warehouse/add');?>">添加仓库</a><?php endif; ?></div>
</div>
...
<th  width="15%"  ><span>仓库编号</span></th>
<th  width="25%"  style="text-align:left" ><span>仓库名称</span></th>
<th  width="15%"  ><span>负责人</span></th>
<th  width="25%" style="text-align:left" ><span>场所地址</span></th>
<th  width="15%"  ><span>操作</span></th>
</tr></thead>
<tbody>
<?php if(is_array($list)): foreach($list as $key=>$item): ?><tr class="<?php echo ($key%2 == 0?'odd':'even'); ?>" >
<td class="data"><span><?php echo ($item["wh_id"]); ?></span></td>
<td class="data"><span><?php echo ($item["wh_munber"]); ?></span></td>
<td class="data" style="text-align:left" ><span><?php echo ($item["wh_name"]); ?></span></td>
<td class="data"  ><span><?php echo ($item["wh_director"]); ?></span></td>
<td class="data" style="text-align:left" ><span><?php echo ($item["wh_address"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Warehouse/edit?wh_id='.$item['wh_id'].'');?>">修改</a> <a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Warehouse/whdel?wh_id='.$item['wh_id'].'');?>';" >删除</a></span></td>
