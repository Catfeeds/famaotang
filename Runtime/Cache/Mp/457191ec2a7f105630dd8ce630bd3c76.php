             ...
             <tr>     
			  ...
			  <tr>     
				...
				<tr>     
				  ...
				  <td class="txtleft" >
				<?php if(($dealerinfo["dl_depositpic_str"]) != ""): ?><a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_depositpic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_depositpic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" /> (建议图片大小不要超500k)  <input type="hidden"  value="<?php echo ($dealerinfo["dl_depositpic"]); ?>" name="old_depositpic" />
                  </td>
			    </tr>
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
...
<!--<script type='text/javascript' src='/famaotang/Public/mp/js/sm-city-picker.min.js' charset='utf-8'></script>-->
<script type='text/javascript' src='/famaotang/Public/mp/js/AreaData_min.js' charset='utf-8'></script>
<script type='text/javascript' src='/famaotang/Public/mp/js/Area.js' charset='utf-8'></script>
<script type="text/javascript">
    $(function (){
