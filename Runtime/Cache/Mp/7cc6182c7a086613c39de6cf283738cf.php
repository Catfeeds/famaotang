...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">发货地址</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:30%">
<form action="<?php echo U('Mp/Orders/addresslist');?>"   method="post" name="fmmm"  >
<input    type="text" size="30" maxlength="30"  name="keyword"  class="input"  onfocus="this.value=''"   value="请填写姓名/电话/地址查询"   style="color:#999999"   >   <input type="submit" name="Submit" value="搜 索"  ></form>
</div>
...
<thead><tr>
<th  width="15%"  ><span>收货人</span></th>
<th  width="15%" ><span>电话</span></th>
<th  width="50%"  style="text-align:left" ><span>详细地址</span></th>
<th  width="20%"  ><span>所属代理</span></th>
</tr></thead>
<tbody>
...
<td class="data" ><span><?php echo ($vo["dladd_contact"]); ?></span></td>
<td class="data" ><span><?php echo ($vo["dladd_tel"]); ?></span></td>
<td class="data" style="text-align:left"  ><span><?php echo ($vo["dladd_address"]); ?></span></td>
