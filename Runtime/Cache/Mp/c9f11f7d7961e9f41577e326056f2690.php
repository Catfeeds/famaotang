...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Jfmobi/newslist?news_type='.$news_type.'');?>"><?php echo ($ntitle); ?></A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Jfmobi/news_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data" >
<input type="hidden" value="<?php echo ($jfmonewsinfo["news_id"]); ?>" name="news_id" />
<?php if($newstypeselect == '0' ): ?><input type="hidden" value="<?php echo ($jfmonewsinfo["news_type"]); ?>" name="news_type" /><?php endif; ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >标题：</td>
				  <td class="txtleft" ><input    type="text" size="50" maxlength="50"  name="news_title"  class="input"  value="<?php echo ($jfmonewsinfo["news_title"]); ?>"   >  </td>
			  </tr>
			  <?php if($newstypeselect == '1' ): ?><tr>     
                  <td height="40"   class="txtright" >分类：</td>
				  <td class="txtleft" >
				  <select name="news_type"   class="select" >
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft"  style="padding:5px 0 5px 0">
				  <?php if(($jfmonewsinfo["news_pic_str"]) != ""): echo ($jfmonewsinfo["news_pic_str"]); endif; ?> <input name="pic_file" type="file" /> (建议图片尺寸为320px X 320px,文件小于300k)
				  </td>
			  </tr>
			   <tr>     
                  <td height="40"   class="txtright" >内容：</td>
				  <td class="txtleft" ><textarea name="econtent" id="econtent" style="width:640px;height:500px;visibility:hidden;"><?php echo (htmlspecialchars($jfmonewsinfo["news_content"])); ?></textarea></td>
			  </tr>
