...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>" >首页</a>　&gt;　<A href="#" >代理积分</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:40%">
<form action="<?php echo U('Mp/Dljf/index');?>"   method="post" name="fmmm"  >
...
<select name="dl_status"   class="select"   onChange="document.location.href ='<?php echo U('Mp/Dljf/index');?>?dl_type=<?php echo ($dl_type); ?>&dl_status='+this.value;" >
...
　
<select name="dl_type"   class="select" style="width:140px" onChange="document.location.href ='<?php echo U('Mp/Dljf/index');?>?dl_status=<?php echo ($dl_status); ?>&dl_type='+this.value;" >
...
<td class="data"><span><?php echo ($item["dl_totaljf"]); ?></span></td>
<td class="data"><span><?php echo ($item["dl_surplusjf"]); ?></span></td>
<td class="data"><span><?php if(($qypurview["15004"]) == "15004"): ?><a href="<?php echo U('Mp/Dljf/changedjf?dl_id='.$item['dl_id'].'');?>">增减分</a>&nbsp;<?php endif; ?><a href="<?php echo U('Mp/Dljf/dljflist?dlusername='.$item['dl_username'].'');?>">明细</a></span></td>
