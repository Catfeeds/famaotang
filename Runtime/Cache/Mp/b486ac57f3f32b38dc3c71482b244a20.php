...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Jfmobi/newslist?news_type='.$news_type.'');?>"><?php echo ($ntitle); ?></A></div>
<div class="nav_r"><a href="<?php echo U('Mp/Jfmobi/newsadd?news_type='.$news_type.'');?>">添 加</a></div>
</div>
...
<th  width="45%"  style="text-align:left" ><span>标题</span></th>
<th  width="15%" ><span>分类</span></th>
<th  width="15%" ><span>日期</span></th>
<th  width="15%" ><span>操作</span></th>
</tr></thead>
<tbody>
<?php if(is_array($list)): foreach($list as $key=>$item): ?><tr class="<?php echo ($key%2 == 0?'odd':'even'); ?>" >
<td class="data" ><span><?php echo ($item["news_pic_str"]); ?></span></td>
<td class="data" style="text-align:left"  ><span><?php echo ($item["news_title"]); ?></span></td>
<td class="data"><span><?php echo ($item["news_type_str"]); ?></span></td>
<td class="data"><span><?php echo (date('Y-m-d H:i:s',$item["news_addtime"])); ?></span></td>
<td class="data"><span><?php echo ($item["news_isgg_str"]); ?> <a href="<?php echo U('Mp/Jfmobi/newsedit?news_id='.$item['news_id'].'');?>" >修改</a> <a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Jfmobi/news_delete?news_id='.$item['news_id'].'');?>';" >删除</a></span></td>
