...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dljf/dljfgift');?>">礼品管理</A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Dljf/dljfgift_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data" >
<input type="hidden" value="<?php echo ($jfgiftinfo["gif_id"]); ?>" name="gif_id" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >礼品名称：</td>
				  <td class="txtleft" ><input    type="text" size="50" maxlength="50"  name="gif_name"  class="input"  value="<?php echo ($jfgiftinfo["gif_name"]); ?>"   >  * </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >图片：</td>
				  <td  class="txtleft" >
				  <?php if(($jfgiftinfo["gif_pic_str"]) != ""): ?><a href="/Public/uploads/product/<?php echo ($jfgiftinfo["gif_pic"]); ?>" target="_blank" ><?php echo ($jfgiftinfo["gif_pic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" /> (建议图片大小:600X600) <input type="hidden"  value="<?php echo ($jfgiftinfo["gif_pic"]); ?>" name="old_gif_pic" />
				  </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >所需积分：</td>
				  <td  class="txtleft" ><input type="text" size="8" maxlength="8"  name="gif_jf" class="input" value="<?php echo ($jfgiftinfo["gif_jf"]); ?>" > *</td>
			  </tr>
			  
			   <tr id="shiwulipin"  >     
                  <td height="40"  class="txtright" >提供未兑数量：</td>
				  <td  class="txtleft" ><input type="text" size="8" maxlength="8"  name="gif_qty" class="input" value="<?php echo ($jfgiftinfo["gif_qty"]); ?>" > *</td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >礼品描述：</td>
				  <td  class="txtleft" ><textarea cols="50" rows="8" name="gif_des"  ><?php echo ($jfgiftinfo["gif_des"]); ?></textarea><br /><br /></td>
			  </tr>
