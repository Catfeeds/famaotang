...
<thead><tr>
<th  width="20%" style="text-align:left"><span>级别</span></th>
<th  width="25%"  style="text-align:left" ><span>业绩区间</span></th>
<th  width="15%" ><span>奖金</span></th>
...
<td class="data" style="text-align:left"  ><span><?php echo ($item["dlt_name"]); ?></span></td>
<td class="data" style="text-align:left" ><span><?php echo ($item["smfr_countdatestr"]); echo ($item["smfr_saleunitstr"]); ?> <?php echo ($item["smfr_minsalestr"]); ?> - <?php echo ($item["smfr_maxsalestr"]); ?></span></td>
<td class="data"><span><?php echo ($item["smfr_fanlievalstr"]); echo ($item["smfr_fanliratestr"]); ?></span></td>
<td class="data"><span><?php echo ($item["smfr_remark"]); ?></span></td>
<td class="data"><span><?php if(($qypurview["99999"]) == "99999"): ?><a href="<?php echo U('Mp/Fanli/salemonfanlirate_edit?smfr_id='.$item['smfr_id'].'');?>">修改</a> <!--<a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Fanli/salemonfanlirate_del?smfr_id='.$item['smfr_id'].'');?>';" >删除</a>--><?php endif; ?></span></td>
