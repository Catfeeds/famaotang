...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Product/proprice');?>">价格体系</A>　&gt;　<A href="#">修改价格体系</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Product/propriceedit_save');?>"   method="post" name="fmmm" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <?php if(is_array($typelist)): foreach($typelist as $key=>$item): ?><tr>     
                  <td height="40"  class="txtright" ><?php echo ($item["dlt_name"]); ?>：</td>
				  <td  class="txtleft" >
				  价格：<input    type="text"  size="6" maxlength="6"  name="pri_price<?php echo ($item["dlt_id"]); ?>"  class="input"  value="<?php echo (number_format($item["priprice"],2,'.','')); ?>"   > 元
				  　　最低补货：<input    type="text"  size="6" maxlength="6"  name="pri_minimum<?php echo ($item["dlt_id"]); ?>"  class="input"  value="<?php echo ($item["pri_minimum"]); ?>"   > 
				 <?php if($qypurview["15001"] == '15001' ): ?>　　代理积分：<input    type="text"  size="6" maxlength="6"  name="pri_jifen<?php echo ($item["dlt_id"]); ?>"  class="input"  value="<?php echo ($item["pri_jifen"]); ?>"   ><?php endif; ?>
