...
<td class="data"><span><a href="<?php echo U('Mp/Product/active?pro_id='.$item['pro_id'].'&pro_active='.$item['pro_active'].'');?>" ><img src="/Public/mp/static/<?php echo ($item['pro_active'] == 0?'no':'yes'); ?>.gif" /></a></span></td>
