...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dealer/index');?>">经销商管理</A>　&gt;　<A href="#">导出数据</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">

<form action="<?php echo U('Mp/Dealer/dealerexport');?>"   method="post" name="fmmm" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
				  ...
				  <td class="txtleft" >
				  <select name="dl_type"   class="select" style="width:140px"  >
...
<tr>     
                  <td height="40"   class="txtright" >排序：</td>
				  <td class="txtleft" >
				 <select name="orderby"   class="select"   >
					<option value="0"  >按申请时间降序　　</option>
					<option value="1"  >按级别降序</option>
					</select> </td>
			  </tr>
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="确认导出" class="botton" >　　　<input name="" value="返 回" onclick="javascript:window.history.go(-1);" class="botton" type="reset">
            </td>
			  </tr>
			</table>
</form>
