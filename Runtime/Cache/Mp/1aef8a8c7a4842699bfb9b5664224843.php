...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dealer/index');?>">经销商管理</A>　&gt;　<A href="<?php echo U('Mp/Dealer/tree');?>">经销商架构树</A>　&gt;　<A href="#">搜索结果</A></div>
<div class="nav_r"></div>
</div>
