...
<div class="nav_l"><a href="<?php echo U('/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dealer/index');?>">经销商管理</A>　&gt;　<A href="#">经销商详情</A></div>
<div class="nav_r"></div>
</div>
             ...
             <tr>     
			  ...
			  <?php if(!empty($dealerinfo["dl_wxheadimg"])): ?><tr>
               ...
               <?php if($qypurview["90001"] == '90001'): ?><tr>     
					  ...
					  <td  class="txtleft" >
						  <?php if(!empty($dealerinfo["dl_username"])): echo ($dealerinfo["dl_username"]); endif; ?>
					  </td>
				  </tr><?php endif; ?>
			  <tr>     
			  ...
			  <tr>     
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" ><?php if(($dealerinfo["dl_country"]) == "1"): ?>缅甸<?php endif; echo ($dealerinfo["dl_address"]); ?></td>
			  </tr>
			   <tr>     
              ...
              <?php if(($dealerinfo["dl_idcardpic_str"]) != ""): ?><tr>     
                  <td height="40"  class="txtright" >身份证图片：</td>
				  <td  class="txtleft"  style="padding:10px 0 10px 0">
				  <a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_idcardpic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_idcardpic_str"]); ?></a>
				  <?php if(($dealerinfo["dl_idcardpic2_str"]) != ""): ?><a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_idcardpic2"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_idcardpic2_str"]); ?></a><?php endif; ?>
				  </td>
			  </tr><?php endif; ?>
			  
			   <?php if(($dealerinfo["dl_paypic"]) != ""): ?><tr>     
                  <td height="40"  class="txtright" >支付凭证：</td>
				  <td  class="txtleft"  style="padding:10px 0 10px 0">
				  <a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_paypic"]); ?>" target="_blank" ><img src="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_paypic"]); ?>"   border="0" style="vertical-align:middle; width:15%" ></a>
				  </td>
			  </tr><?php endif; ?>
			  ...
			  <tr>     
			   ...
			   <tr>     
			     ...
			     <td  class="txtleft" ><?php echo (nl2br($dealerinfo["dl_remark"])); ?></td>
			  </tr>
             ...
             <input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
			   ...
			   <td height="60"  colspan="2">
				   ...
				   <table width="80%" border="0" cellspacing="0" cellpadding="0"  style="margin:0 auto" >
					  <tr>     
						  <td height="40"  colspan="4" class="txtleft" ><b>操作日志：</b></td>
					  </tr>
					  <tr>     
						  <td height="40"   width="35%" class="txtleft" >操作</td>
						  <td width="25%" class="txtleft" >操作人</td>
						  <td width="20%" class="txtleft" >时间</td>
						  <td width="20%" class="txtleft" >IP</td>
					  </tr>
					  <?php if(is_array($logslist)): foreach($logslist as $key=>$item): ?><tr>     
						  <td height="28" class="txtleft" ><?php echo ($item["dlg_action"]); ?></td>
						  <td  class="txtleft" ><?php echo ($item["dlg_operatstr"]); ?></td>
						  <td  class="txtleft" ><?php echo (date('Y-m-d H:i:s',$item["dlg_addtime"])); ?></td>
						  <td  class="txtleft" ><?php echo ($item["dlg_ip"]); ?></td>
