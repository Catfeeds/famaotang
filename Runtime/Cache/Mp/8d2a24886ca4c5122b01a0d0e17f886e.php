...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dealer/index');?>">经销商管理</A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Dealer/edit_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <?php if($qypurview["90002"] == '90002'): if(!empty($dealerinfo["dl_openid"])): ?><tr>     
                  <td height="40"   class="txtright" >已绑定微信</td>
				  <td class="txtleft" ></td>
			  </tr>
			  <tr>
				  <td height="40"  class="txtright" > OpenID：</td>
				  <td  class="txtleft" ><?php echo ($dealerinfo["dl_openid"]); ?>
				  </td>
			  </tr><?php endif; ?>
              <?php if(!empty($dealerinfo["dl_wxnickname"])): ?><tr>
				  <td height="40"  class="txtright" > 微信名称：</td>
				  <td  class="txtleft" ><?php echo ($dealerinfo["dl_wxnickname"]); ?>
				  </td>
			  </tr><?php endif; ?>
			  
			  <?php if(!empty($dealerinfo["dl_wxheadimg"])): ?><tr>
				  <td height="40"  class="txtright" > 头像：</td>
				  <td  class="txtleft" > <img src="<?php echo ($dealerinfo["dl_wxheadimg"]); ?>"    style="width:60px; height:60px" />
				  </td>
			  </tr><?php endif; endif; ?>
			  <?php if($qypurview["90001"] == '90001'): ?><tr>     
					  <td height="40"  class="txtright" > 登录账户：</td>
					  <td  class="txtleft" >
					  <?php if($dealerinfo["dl_id"] != '0'): if(!empty($dealerinfo["dl_username"])): echo ($dealerinfo["dl_username"]); ?>
						  <?php else: ?>
						  <input type="text" size="25" maxlength="25"  name="dl_username" class="input" value="" > * 用户名由 A--Z,a--z,0--9,_ 组成,4-20位<?php endif; ?>
					  <?php else: ?>
					    <input type="text" size="25" maxlength="25"  name="dl_username" class="input" value=""   > * 用户名由 A--Z,a--z,0--9,_ 组成,4-20位<?php endif; ?>
					  </td>
				  </tr>
				  <tr>     
					  <td height="40"  class="txtright" > 登录密码：</td>
					  <td  class="txtleft" ><input  type="password" size="25" maxlength="25"  name="dl_pwd" class="input" value=""   > <?php if(!empty($dealerinfo["dl_username"])): ?>如果为空则不修改密码<?php else: ?> *<?php endif; ?></td>
				  </tr><?php endif; ?>
			  <tr>     
                  <td height="40"   class="txtright" >经销商编号：</td>
				  <td class="txtleft" ><input    type="text" size="25" maxlength="25"  name="dl_number"  class="input"  value="<?php echo ($dealerinfo["dl_number"]); ?>"   >  * </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" > 经销商名称：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="50"  name="dl_name" class="input" value="<?php echo ($dealerinfo["dl_name"]); ?>" > *</td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >联系人：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="dl_contact" class="input" value="<?php echo ($dealerinfo["dl_contact"]); ?>" > *</td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >电话：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="dl_tel" class="input" value="<?php echo ($dealerinfo["dl_tel"]); ?>" > *</td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >传真：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="dl_fax" class="input" value="<?php echo ($dealerinfo["dl_fax"]); ?>" > </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >地址：</td>
				  <td  class="txtleft" ><input type="text" size="50" maxlength="100"  name="dl_address" class="input" value="<?php echo ($dealerinfo["dl_address"]); ?>" ></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >Email：</td>
				  <td  class="txtleft" ><input type="text" size="50" maxlength="100"  name="dl_email" class="input" value="<?php echo ($dealerinfo["dl_email"]); ?>" > </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >QQ：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="dl_qq" class="input" value="<?php echo ($dealerinfo["dl_qq"]); ?>" > </td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >微信号：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="50"  name="dl_weixin" class="input" value="<?php echo ($dealerinfo["dl_weixin"]); ?>" > 注:是微信号不是微信昵称 微信号由 A--Z,a--z,0--9,_-组成,6-20位</td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >身份证：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="dl_idcard" class="input" value="<?php echo ($dealerinfo["dl_idcard"]); ?>" > </td>
			  </tr>

<!--			  <tr>     
                  <td height="40"  class="txtright" >身份证图片：</td>
				  <td  class="txtleft"  style="padding:10px 0 10px 0">
				  正面：<?php if(($dealerinfo["dl_idcardpic_str"]) != ""): ?><a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_idcardpic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_idcardpic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" /> (建议图片大小不要超500k)  <input type="hidden"  value="<?php echo ($dealerinfo["dl_idcardpic"]); ?>" name="old_idcardpic" />
				 
				 <br /><br />
				 背面：<?php if(($dealerinfo["dl_idcardpic2_str"]) != ""): ?><a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_idcardpic2"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_idcardpic2_str"]); ?></a><?php endif; ?> <input name="pic_file2" type="file" />  <input type="hidden"  value="<?php echo ($dealerinfo["dl_idcardpic2"]); ?>" name="old_idcardpic2" />
				  </td>
			  </tr>-->
			  ...
			  <tr>     
				  ...
				  <td  class="txtleft"  style="padding:10px 0 10px 0">
				  <?php if(($dealerinfo["dl_pic_str"]) != ""): ?><a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_pic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_pic_str"]); ?></a><?php endif; ?>
				  </td>
			  </tr>
			  <?php if($dealerinfo["dl_stockpic"] != ''): ?><tr>     
	                  <td height="40"  class="txtright" >股权证书：</td>
					  <td  class="txtleft"  style="padding:10px 0 10px 0">
					  <?php if(($dealerinfo["dl_pic_str"]) != ""): ?><a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_stockpic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_stockpic_str"]); ?></a><?php endif; ?>
					  </td>
				  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright" >备注：</td>
			     <td  class="txtleft"   ><textarea cols="60" rows="5" name="dl_remark"  ><?php echo ($dealerinfo["dl_remark"]); ?></textarea>(100字内)</td>
			  </tr>
              <?php if(($qypurview["10005"]) == "10005"): ?><tr>     
                  <td height="40"  class="txtright" >经销商级别：</td>
				  <td  class="txtleft" ><?php echo ($dealerinfo["dlt_name"]); ?>
				  </td>
			  </tr><?php endif; ?>
			    <?php if(($dealerinfo["dlstt_name"]) != ""): ?><tr>     
					  <td height="40"  class="txtright" >门店级别：</td>
					  <td  class="txtleft" >
			   ...
			   <?php if(($qypurview["90003"]) == "90003"): ?><tr>     
                  <td height="40"  class="txtright" >上家经销：</td>
				  <td  class="txtleft" ><?php echo ($dealerinfo["dl_belong_name"]); ?> 
				  </td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >推荐人：</td>
				  <td  class="txtleft" ><?php echo ($dealerinfo["dl_referee_name"]); ?> 
				  </td>
			  </tr><?php endif; ?>

			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="<?php echo ($atitle); ?>" class="botton" >　　　　<a href="<?php echo U('Mp/Dealer/index?dl_type='.$dl_type.'&dl_status='.$dl_status.'');?>" class="botton"><< 返 回</a>
            </td>
			  </tr>
			</table>
</form>
