...
<!--			  <tr>     
				  ...
				  正面：<?php if(($dealerinfo["dl_idcardpic_str"]) != ""): ?><a href="/Public/uploads/dealer/<?php echo ($dealerinfo["dl_idcardpic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_idcardpic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" /> (建议图片大小不要超500k)  <input type="hidden"  value="<?php echo ($dealerinfo["dl_idcardpic"]); ?>" name="old_idcardpic" />
				 
				 <br /><br />
				 背面：<?php if(($dealerinfo["dl_idcardpic2_str"]) != ""): ?><a href="/Public/uploads/dealer/<?php echo ($dealerinfo["dl_idcardpic2"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_idcardpic2_str"]); ?></a><?php endif; ?> <input name="pic_file2" type="file" />  <input type="hidden"  value="<?php echo ($dealerinfo["dl_idcardpic2"]); ?>" name="old_idcardpic2" />
				  </td>
			  </tr>-->
			  ...
			  <tr>     
				  ...
				  <td  class="txtleft"  style="padding:10px 0 10px 0">
				  <?php if(($dealerinfo["dl_pic_str"]) != ""): ?><a href="/Public/uploads/dealer/<?php echo ($dealerinfo["dl_pic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_pic_str"]); ?></a><?php endif; ?>
				  </td>
			  </tr>
			  <?php if($dealerinfo["dl_stockpic"] != ''): ?><tr>     
	                  <td height="40"  class="txtright" >股权证书：</td>
					  <td  class="txtleft"  style="padding:10px 0 10px 0">
					  <?php if(($dealerinfo["dl_pic_str"]) != ""): ?><a href="/Public/uploads/dealer/<?php echo ($dealerinfo["dl_stockpic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_stockpic_str"]); ?></a><?php endif; ?>
					  </td>
				  </tr><?php endif; ?>
			   <tr>     
