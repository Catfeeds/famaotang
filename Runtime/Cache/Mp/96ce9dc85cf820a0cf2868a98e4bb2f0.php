...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Product/proprice');?>">价格体系</A>　&gt;　<A href="#">返利设置</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Product/profanli_save');?>"   method="post" name="fmmm" >
<input type="hidden" value="<?php echo ($proinfo["pro_id"]); ?>" name="pro_id" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
                  <td height="40"   width="15%" class="txtright" ></td>
				  <td width="85%" class="txtleft" ></td>
			  </tr>
			  <tr>     
                  <td height="40"   class="txtright" >产品名称：</td>
				  <td class="txtleft" ><?php echo ($proinfo["pro_name"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >产品编号：</td>
				  <td  class="txtleft" ><?php echo ($proinfo["pro_number"]); ?></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >零售价：</td>
				  <td  class="txtleft" ><?php echo (number_format($proinfo["pro_price"],2,'.','')); ?> 元</td>
			  </tr>
	
			  <tr>     
                  <td height="50"  class="txtright" valign="top"  style="padding-top:5px">返利设置：</td>
				  <td  class="txtleft"  style="padding-bottom:20px; line-height:26px">
	...
	<tbody>
<?php if(is_array($typelist)): foreach($typelist as $key=>$item): ?><tr class="odd" >
	<td class="data"  ><span><?php echo ($item["pfl_dltypename"]); ?></span></td>
	<td class="data"  ><span>推荐</span></td>
	<td class="data"><span><?php echo ($item["pfl_tjdltypename"]); ?></span></td>
	<td class="data"><span><input    type="text"  size="6" maxlength="6"  name="pfl_fanli1_<?php echo ($item["pfl_dltype"]); ?>_<?php echo ($item["pfl_tjdltype"]); ?>"  class="input"  value="<?php echo (number_format($item["pfl_fanli1"],2,'.','')); ?>"   ></span></td>
    <td class="data"><span><input    type="text"  size="6" maxlength="6"  name="pfl_fanli2_<?php echo ($item["pfl_dltype"]); ?>_<?php echo ($item["pfl_tjdltype"]); ?>"  class="input"  value="<?php echo (number_format($item["pfl_fanli2"],2,'.','')); ?>"   ></span></td>
			  ...
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="确认修改" class="botton" >　<input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
            </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" ></td>
				  <td  class="txtleft" ><!--
				  直推奖-如：A总代 平级推荐 B总代 A获得B销售该产品的佣金<br />
				  间推奖-如：A总代 平级推荐 B总代，B总代平级推荐C总代 A获得C销售该产品的佣金<br />
				  
				  佣金数字在1-0间，则以下单价的百分比计算，如0.03代表以下单价的3%计算，如果大于1，则以具体多少元计算<br/>-->
				  </td>
			  </tr>
			</table>
</form>
