...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Product/proprice');?>">价格体系</A>　&gt;　<A href="#">详细</A></div>
<div class="nav_r"></div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
                  <td height="40"   width="10%" class="txtright" ></td>
				  <td width="90%" class="txtleft" ></td>
			  </tr>
			  <tr>     
			  ...
			  <?php if(is_array($typelist)): foreach($typelist as $key=>$item): ?><tr>     
				  ...
				  <td  class="txtleft" >
				  代理价：<?php echo (number_format($item["priprice"],2,'.','')); ?> 元　　
				  最低补货：<?php echo ($item["pri_minimum"]); ?>　　
				  </td>
