...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">积分明细</A></div>
<div class="nav_r"><?php if($back == '1' ): ?><a href="<?php echo U('Mp/Dljf/index');?>" >&lt;&lt; 返 回</a><?php else: ?><a href="javascript:window.history.go(-1);" >&lt;&lt; 返 回</a><?php endif; ?></div>
</div>
...
<form action="<?php echo U('Mp/Dljf/dljflist');?>"   method="post" name="fmmm"  >
...
<thead><tr>
<th  width="18%" style="text-align:left"><span>积分代理</span></th>
<th  width="15%"  ><span>积分类型</span></th>
<th  width="10%" ><span>积分</span></th>
<th  width="15%" ><span>相关订单</span></th>
<th  width="12%" ><span>时间</span></th>
<th  width="20%"  ><span>积分说明</span></th>
...
<td class="data" ><span><?php echo ($item["dljf_typestr"]); ?></span></td>
<td class="data"><span><?php echo ($item["dljf_jfstr"]); ?></span></td>
<td class="data"><span><?php if(($item["dljf_orderid"] != '') AND ($item["dljf_orderid"] != '0') ): ?><a href="<?php echo U('Mp/Orders/orderdetail?od_id='.$item['dljf_odid'].'&odbl_id='.$item['dljf_odblid'].'');?>"  ><?php echo ($item["dljf_orderid"]); ?></a><?php endif; ?></span></td>
<td class="data"><span><?php echo (date('Y-m-d H:i:s',$item["dljf_addtime"])); ?></span></td>
<td class="data"><span><?php echo ($item["dljf_remark"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Dljf/dljfdetail?dljf_id='.$item['dljf_id'].'');?>">详细</a></span></td>
