...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">子用户管理</A></div>
<div class="nav_r"><a href="<?php echo U('Mp/Subuser/subuseradd');?>">添加子用户</a></div>
</div>
...
<th  width="20%"  ><span>最近登录</span></th>
<th  width="15%"  ><span>授权</span></th>
<th  width="15%"  ><span>操作</span></th>
</tr></thead>
<tbody>
<?php if(is_array($qysubuserlist)): $key = 0; $__LIST__ = $qysubuserlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="<?php echo ($key%2 == 0?'odd':'even'); ?>" >
