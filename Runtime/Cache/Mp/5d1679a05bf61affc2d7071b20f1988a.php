...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Tongji/index');?>">出货统计</A> 　&gt;　详细</div>
<div class="nav_r"><a href="#" onClick="javascript:window.history.go(-1);" ><< 返 回</a></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:80%;">
统计日期：从 <b  style="font-size:14px"><?php echo ($begintime); ?></b> 到 <b  style="font-size:14px"><?php echo ($endtime); ?></b>　　　　出货方：<b  style="font-size:14px"><?php echo ($fdealer["dl_name"]); ?> <?php echo ($fdealer["dl_contact"]); ?></b>　　　　收货方：<b  style="font-size:14px"><?php echo ($sdealer["dl_name"]); ?> <?php echo ($sdealer["dl_contact"]); ?></b>
</div>
...
<th  width="70%"   style="text-align:left"><span>产品名称/编号</span></th>
<th  width="20%"  ><span>数量(小标)</span></th>
</tr></thead>
<tbody>
<?php if(empty($list)): ?><tr class="odd" >
<td class="data"  colspan="3"  style="text-align:center">没有记录</td>
</tr>
<?php else: ?>
...
<td class="data" style="text-align:left"><span><?php echo ($vo["pro_name"]); ?> (<?php echo ($vo["pro_number"]); ?>)</span></td>
<td class="data" ><span><?php echo ($vo["sumqty"]); ?></span></td>
