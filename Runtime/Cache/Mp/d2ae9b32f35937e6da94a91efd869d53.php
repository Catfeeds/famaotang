...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Shipment/index');?>">出货管理</A>　&gt;　<A href="#">出货导入</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Shipment/import_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data" >
			  ...
			  <tr>     
			   ...
			   <tr>     
				  ...
				  <select name="ship_whid"   class="select" >
					...
					<?php if(is_array($warehouselist)): $key = 0; $__LIST__ = $warehouselist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vo["wh_id"]); ?>"  ><?php echo ($vo["wh_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				  </select> *
		      </td>
			  </tr>
			   <tr>     
		          ...
		          <select name="ship_dealer"  id="ship_dealer"     class="select"     >
					...
					<?php if(is_array($dealerlist)): $key = 0; $__LIST__ = $dealerlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vo["dl_id"]); ?>"  ><?php echo ($vo["dl_number"]); ?> <?php echo ($vo["dl_name"]); ?> (<?php echo ($vo["dl_username"]); ?>)</option><?php endforeach; endif; else: echo "" ;endif; ?>
				  </select>
			   ...
			   <tr>     
				  ...
				  <select name="ship_pro"   class="select" >
					...
					<?php if(is_array($productlist)): $key = 0; $__LIST__ = $productlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vo["pro_id"]); ?>"  ><?php echo ($vo["pro_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				  </select> *
		      </td>
			  </tr>
