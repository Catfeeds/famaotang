...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">产品分类管理</A></div>
<div class="nav_r"><a href="<?php echo U('Mp/Product/typeadd');?>">添加产品分类</a></div>
</div>
...
<th  width="50%"  style="text-align:left" ><span>类型名称</span></th>
<th  width="40%"  ><span>操作</span></th>
</tr></thead>
<tbody>
<?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="even" >
<td class="data" ><span><?php echo ($vo["protype_id"]); ?></span></td>
<td class="data" style="text-align:left" ><span><?php echo ($vo["protype_name"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Product/typeorder?protype_id='.$vo['protype_id'].'&active=shang');?>"  title="上移">↑</a>　<a href="<?php echo U('Mp/Product/typeorder?protype_id='.$vo['protype_id'].'&active=xia');?>" title="下移" >↓</a>　<a href="<?php echo U('Mp/Product/typeedit?protype_id='.$vo['protype_id'].'');?>">修改</a>　<a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Product/typedelete?protype_id='.$vo['protype_id'].'');?>';" >删除</a></span></td>
</tr>
<?php if(is_array($vo['subarr'])): $i = 0; $__LIST__ = $vo['subarr'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><tr class="odd" >
<td class="data" ><span><?php echo ($sub["protype_id"]); ?></span></td>
<td class="data" style="text-align:left" ><span>　　<?php echo ($sub["protype_name"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Product/typeorder?protype_id='.$sub['protype_id'].'&active=shang');?>"  title="上移">↑</a>　<a href="<?php echo U('Mp/Product/typeorder?protype_id='.$sub['protype_id'].'&active=xia');?>" title="下移" >↓</a>　<a href="<?php echo U('Mp/Product/typeedit?protype_id='.$sub['protype_id'].'');?>">修改</a>　<a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Product/typedelete?protype_id='.$sub['protype_id'].'');?>';" >删除</a></span></td>
