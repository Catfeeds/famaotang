...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">代理资金</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:40%">
<form action="<?php echo U('Mp/Capital/index');?>"   method="post" name="fmmm"  >
...
　
<select name="dl_type"   class="select" style="width:140px" onChange="document.location.href ='<?php echo U('Mp/Capital/index');?>?dl_status=<?php echo ($dl_status); ?>&dl_type='+this.value;" >
...
<th  width="11%" ><span>上家代理</span></th>
<th  width="11%"  ><span>推荐人</span></th>
<th  width="15%"  ><span>余额</span></th>
...
<td class="data"><span>余：<?php echo (number_format($item["yuesurplus"],2,'.','')); ?>元 <br />冻：<?php echo (number_format($item["yuefreezesum"],2,'.','')); ?>元 </span></td>
<td class="data"><span>
<a href="<?php echo U('Mp/Capital/dlbalance?dlusername='.$item['dl_username'].'');?>">余额明细</a>　<a href="<?php echo U('Mp/Capital/yueadd?dl_id='.$item['dl_id'].'');?>">增减余额</a>
</span></td>
