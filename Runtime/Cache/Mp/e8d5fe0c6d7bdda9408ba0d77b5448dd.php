...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">按月销售奖</A></div>
<div class="nav_r"><a href="<?php echo U('Mp/Fanli/make_salemonthly');?>">生成月销售奖</a>　<a href="<?php echo U('Mp/Fanli/salemonfanlirate');?>">销售奖设置</a></div>
</div>
...
<form action="<?php echo U('Mp/Fanli/salemonthly');?>"   method="post" name="fmmm"  >
...
<option value="2024"    <?php if($year == '2024' ): ?>selected<?php endif; ?>  >2024　</option>
<option value="2023"    <?php if($year == '2023' ): ?>selected<?php endif; ?>  >2023　</option>
<option value="2022"    <?php if($year == '2022' ): ?>selected<?php endif; ?>  >2022　</option>
<option value="2021"    <?php if($year == '2021' ): ?>selected<?php endif; ?>  >2021　</option>
<option value="2020"    <?php if($year == '2020' ): ?>selected<?php endif; ?>  >2020　</option>
...
<option value="1"    <?php if($month == '1' ): ?>selected<?php endif; ?>  >1　</option>
<option value="2"    <?php if($month == '2' ): ?>selected<?php endif; ?>  >2　</option>
<option value="3"    <?php if($month == '3' ): ?>selected<?php endif; ?>  >3　</option>
<option value="4"    <?php if($month == '4' ): ?>selected<?php endif; ?>  >4　</option>
<option value="5"    <?php if($month == '5' ): ?>selected<?php endif; ?>  >5　</option>
<option value="6"    <?php if($month == '6' ): ?>selected<?php endif; ?>  >6　</option>
<option value="7"    <?php if($month == '7' ): ?>selected<?php endif; ?>  >7　</option>
<option value="8"    <?php if($month == '8' ): ?>selected<?php endif; ?>  >8　</option>
<option value="9"    <?php if($month == '9' ): ?>selected<?php endif; ?>  >9　</option>
<option value="10"    <?php if($month == '10' ): ?>selected<?php endif; ?>  >10　</option>
<option value="10"    <?php if($month == '11' ): ?>selected<?php endif; ?>  >11　</option>
<option value="12"    <?php if($month == '12' ): ?>selected<?php endif; ?>  >12　</option>
</select>


　　
<input    type="text" size="20" maxlength="20"  name="dlusername"  class="input"   onfocus="this.value=''"   value="<?php echo ($dlusername); ?>"   style="color:#999999"  >　<input type="submit" name="Submit" value="查 询"  >
</form>
</div>
</div>
<div class="height10"></div>
...
<thead><tr>
<th  width="15%" style="text-align:left"><span>收款代理</span></th>
<th  width="15%"  style="text-align:left" ><span>付款代理</span></th>
<th  width="15%" ><span>奖励</span></th>
<th  width="15%" ><span>业绩</span></th>
<th  width="10%" ><span>年月</span></th>
<th  width="20%" ><span>说明</span></th>
<th  width=""  ><span>对应返利明细</span></th>
</tr></thead>
<tbody>
...
<td class="data"><span><?php echo ($item["sm_rewardstr"]); ?> 元</span></td>
<td class="data"><span><?php if(($item["sm_mysalestr"] != '')): ?>个人：<?php echo ($item["sm_mysalestr"]); endif; if(($item["sm_teamsalestr"] != '') ): ?><br />团队：<?php echo ($item["sm_teamsalestr"]); endif; ?></span></td>
<td class="data"><span><?php echo (date('Y-m',$item["sm_date"])); ?></span></td>
<td class="data"><span><?php echo ($item["sm_remark"]); ?></span></td>
<td class="data"><span><?php if(($item["sm_flid"] != '') AND ($item["sm_flid"] != '0') ): ?><a href="<?php echo U('Mp/Fanli/fanlidetail?fl_id='.$item['sm_flid'].'');?>">返利明细</a><?php endif; ?></span></td>
