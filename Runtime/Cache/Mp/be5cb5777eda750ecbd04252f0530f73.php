...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Fanli/index');?>">代理返利</A>　&gt;　<A href="#">代理返利详细</A></div>
<div class="nav_r"></div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
             <tr>     
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" ><?php echo ($fanlidlinfo["dl_name"]); ?> (<?php echo ($fanlidlinfo["dl_username"]); ?>)</td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >经销商编号：</td>
				  <td  class="txtleft" ><?php echo ($fanlidlinfo["dl_number"]); ?></td>
			  </tr>

			   <tr>     
                  <td height="40"  class="txtright" >电话：</td>
				  <td  class="txtleft" ><?php echo ($fanlidlinfo["dl_tel"]); ?></td>
			  </tr>

			   <tr>     
                  <td height="40"  class="txtright"  >级别：</td>
			     <td  class="txtleft" ><?php echo ($fanlidlinfo["dl_type_str"]); ?></td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >上家代理：</td>
				  <td  class="txtleft" ><?php echo ($fanlidlinfo["dl_belong_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >推荐人：</td>
				  <td  class="txtleft" ><?php echo ($fanlidlinfo["dl_referee_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >已收返利：</td>
				  <td  class="txtleft" ><?php echo (number_format($fanlidlinfo["flreceived"],2,'.','')); ?> 元</td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >待收返利：</td>
				  <td  class="txtleft" ><?php echo (number_format($fanlidlinfo["flreadyrec"],2,'.','')); ?> 元</td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >已付返利：</td>
				  <td  class="txtleft" ><?php echo (number_format($fanlidlinfo["flpayed"],2,'.','')); ?> 元</td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >待付返利：</td>
				  <td  class="txtleft" ><?php echo (number_format($fanlidlinfo["flreadypay"],2,'.','')); ?> 元</td>
			  </tr>
