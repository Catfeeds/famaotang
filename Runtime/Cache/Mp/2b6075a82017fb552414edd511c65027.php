...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Product/index');?>">产品管理</A>　&gt;　<A href="#">产品详细</A></div>
<div class="nav_r"></div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
              ...
              <?php if($qypurview["20006"] == '20006' ): ?><tr>     
				  ...
				  <td  class="txtleft" ><?php if(($proinfo["pro_price"] != '') AND ($proinfo["pro_price"] != '0') ): echo ($proinfo["pro_price"]); ?> 元<?php endif; ?></td>
			  </tr><?php endif; ?>
			    <?php if($qypurview["20012"] == '20012' ): ?><tr>     
                  <td height="40"  class="txtright" > 库存：</td>
				  <td  class="txtleft" ><?php echo ($proinfo["pro_stock"]); ?></td>
			  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright" > 单位：</td>
				  <td  class="txtleft" ><?php echo ($proinfo["pro_units"]); ?></td>
			  </tr>
               <?php if($qypurview["20007"] == '20007' ): ?><tr>     
                  <td height="40"  class="txtright" > 产品包装比例：</td>
				  <td  class="txtleft" >大标：<?php echo ($proinfo["pro_dbiao"]); ?>　小标：<?php echo ($proinfo["pro_xbiao"]); ?>　　(一个包装单位里面大标与小标比例，如没有则不用填或为0)</td>
			  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright" >产品类别：</td>
				  <td  class="txtleft" >
				  <?php echo ($proinfo["pro_type_str"]); ?>
				  </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >产品图片：</td>
				  <td  class="txtleft"   style="padding:5px 5px 10px 0" >
				  <a href="/famaotang/Public/uploads/product/<?php echo ($proinfo["pro_pic"]); ?>" target="_blank" ><?php echo ($proinfo["pro_pic_str"]); ?></a>
				  </td>
			  </tr>
			   <?php if($qypurview["20008"] == '20008' ): if(($proinfo["pro_jftype"]) == "2"): ?><tr  >     
                  <td height="40"  class="txtright" >固定积分：</td>
				  <td  class="txtleft" ><?php echo ($proinfo["pro_jifen"]); ?></td>
			  </tr><?php endif; ?>
			  <?php if(($proinfo["pro_jftype"]) == "1"): ?><tr  >     
                  <td height="40"  class="txtright" >随机积分：</td>
				  <td  class="txtleft" ><?php echo ($proinfo["pro_jifen"]); ?>-<?php echo ($proinfo["pro_jfmax"]); ?></td>
			  </tr><?php endif; endif; ?>
			 <?php if($qypurview["15001"] == '15001' ): ?><tr >     
                  <td height="40"  class="txtright" >代理积分：</td>
				  <td  class="txtleft" ><?php echo ($proinfo["pro_dljf"]); ?></td>
			  </tr><?php endif; ?>
         ...
         <?php if($qypurview["20013"] == '20013' ): ?><tr >     
				  ...
				  <?php if(is_array($colorlist)): foreach($colorlist as $key=>$item): ?><div class="coloesize"><?php echo ($item["attr_color"]); ?>　</div><?php endforeach; endif; ?>   
				  </div>
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" ><?php echo (nl2br($proinfo["pro_desc"])); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >备注：</td>
			     <td  class="txtleft" ><?php echo (nl2br($proinfo["pro_remark"])); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >添加时间：</td>
			     <td  class="txtleft" ><?php echo (date('Y-m-d H:i:s',$proinfo["pro_addtime"])); ?></td>
			  </tr>
