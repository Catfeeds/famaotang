...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Jfmobi/haibaolist');?>">海报设置</A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Jfmobi/haibao_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data" >
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
				  ...
				  <td class="txtleft" ><input    type="text" size="30" maxlength="50"  name="ad_name"  class="input"  value=""   > * </td>
			  </tr>
			  <tr>     
                  <td height="40"   class="txtright" >链接：</td>
				  <td class="txtleft" ><input    type="text" size="40" maxlength="100"  name="ad_url"  class="input"  value=""   >  </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >选择图片：</td>
				  <td  class="txtleft" >
				  <input name="pic_file" type="file" /> * (宽度640px,高度不限，但要统一)
				  </td>
			  </tr>
