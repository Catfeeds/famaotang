...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">产品管理</A></div>
<div class="nav_r"><?php if(($qypurview["20004"]) == "20004"): ?><a href="<?php echo U('Mp/Product/typelist');?>">产品分类管理</a><?php endif; ?>　<?php if(($qypurview["20002"]) == "20002"): ?><a href="<?php echo U('Mp/Product/add');?>">添加产品</a><?php endif; ?></div>
</div>
<div class="height10"></div>
<div>
<form action="<?php echo U('Mp/Product/index');?>"   method="post" name="fmmm"  >
<select name="pro_typeid"   class="select"  onChange="document.location.href ='<?php echo U('Mp/Product/index');?>?pro_typeid='+this.value;" >
				  ...
				  </select>　<input    type="text" size="20" maxlength="25"  name="keyword"  class="input"  value="<?php echo ($keyword); ?>"   >   <input type="submit" name="Submit" value="搜 索"  ></form></div>
<div class="height10"></div>
<div class="content">
<table class="table_results" >
<thead><tr>
<th  width="5%" ><span>ID</span></th>
<th  width="10%" ><span>图</span></th>
<th  width="30%" style="text-align:left" ><span>产品名称</span></th>
<th  width="10%" ><span>产品编号</span></th>
<th  width="10%" ><span>产品类别</span></th>
<th  width="7%"  ><span>零售价</span></th>
...
<td class="data"><span><?php echo ($item["pro_id"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Product/view?pro_id='.$item['pro_id'].'');?>"><?php echo ($item["pro_pic_str"]); ?></a></span></td>
<td class="data" style="text-align:left" ><span><?php echo ($item["pro_name"]); ?></span></td>
<td class="data"><span><?php echo ($item["pro_number"]); ?></span></td>
<td class="data"><span><?php echo ($item["pro_typeid_str"]); ?></span></td>
<td class="data"><span><?php if(($item["pro_price"] != '') AND ($item["pro_price"] != '0') ): echo (number_format($item["pro_price"],2,'.','')); endif; ?></span></td>
<td class="data"><span><?php echo (date('Y-m-d',$item["pro_addtime"])); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Product/active?pro_id='.$item['pro_id'].'&pro_active='.$item['pro_active'].'');?>" ><img src="/famaotang/Public/mp/static/<?php echo ($item['pro_active'] == 0?'no':'yes'); ?>.gif" /></a></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Product/view?pro_id='.$item['pro_id'].'');?>">详细</a> <?php if(($qypurview["20002"]) == "20002"): ?><a href="<?php echo U('Mp/Product/edit?pro_id='.$item['pro_id'].'');?>">修改</a><?php endif; ?> <?php if(($qypurview["20003"]) == "20003"): ?><a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Product/delete?pro_id='.$item['pro_id'].'');?>';" >删除</a><?php endif; ?></span></td>
<td class="data"><?php if(($item["pro_remark"]) != ""): ?><span  title="<?php echo ($item["pro_remark"]); ?>"  style="cursor:pointer" >...</span><?php endif; ?></td>
