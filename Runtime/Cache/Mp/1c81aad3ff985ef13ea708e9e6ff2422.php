...
<div class="content">
<form action="<?php echo U('Mp/Jfmobi/edit_save/action/basic');?>"   method="post" name="fmmm"  >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <?php if(($qypurview["70010"]) == "70010"): ?><tr>     
                  <td height="40"   width="25%" class="txtright"  style="font-size:14px; font-weight:bold; padding-top:20px" >编辑基本信息:</td>
				  <td width="75%" class="txtleft" ></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" > 网站名称：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="bas_sitename" class="input" value="<?php echo ($basicinfo["bas_sitename"]); ?>" ></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" > 公司名称：</td>
				  <td  class="txtleft" ><input type="text" size="50" maxlength="50"  name="bas_company" class="input" value="<?php echo ($basicinfo["bas_company"]); ?>" ></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" > 详细地址：</td>
				  <td  class="txtleft" ><input type="text" size="50" maxlength="50"  name="bas_address" class="input" value="<?php echo ($basicinfo["bas_address"]); ?>" ></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" > 热　　线：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="bas_hotline" class="input" value="<?php echo ($basicinfo["bas_hotline"]); ?>" ></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" > 联系电话：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="bas_tel" class="input" value="<?php echo ($basicinfo["bas_tel"]); ?>" ></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" > 传　　真：</td>
				  <td  class="txtleft" ><input type="text" size="25" maxlength="25"  name="bas_fax" class="input" value="<?php echo ($basicinfo["bas_fax"]); ?>" ></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" > 官方网站：</td>
				  <td  class="txtleft" ><input type="text" size="50" maxlength="200"  name="bas_website" class="input" value="<?php echo ($basicinfo["bas_website"]); ?>" ></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" > 微信链接：</td>
				  <td  class="txtleft" ><input type="text" size="50" maxlength="200"  name="bas_weixin" class="input" value="<?php echo ($basicinfo["bas_weixin"]); ?>" ></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" > 微博链接：</td>
				  <td  class="txtleft" ><input type="text" size="50" maxlength="200"  name="bas_weibo" class="input" value="<?php echo ($basicinfo["bas_weibo"]); ?>" ></td>
			  </tr>   
