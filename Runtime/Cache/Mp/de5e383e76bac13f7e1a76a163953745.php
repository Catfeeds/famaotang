...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Orders/cporders');?>">订单管理</A>　&gt;　<A href="#">订单产品出货</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Orders/odshipscanres');?>"   method="post" name="fmmm" >
<input type="hidden" name="od_id" value="<?php echo ($od_id); ?>" />
<input type="hidden" name="odbl_id" value="<?php echo ($odbl_id); ?>" />
<input type="hidden" name="oddt_id" value="<?php echo ($oddt_id); ?>" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >出货订单：</td>
				  <td class="txtleft" ><b><?php echo ($ordersinfo["oddt_orderid"]); ?></b> </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >出货产品：</td>
				  <td  class="txtleft" >
				  <?php echo ($ordersinfo["oddt_proname"]); ?> (<?php echo ($ordersinfo["oddt_pronumber"]); ?>)
		      </td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >收货代理：</td>
				  <td  class="txtleft" >
				  <?php echo ($ordersbase["od_dl_name"]); ?> (<?php echo ($ordersbase["od_dl_username"]); ?>)
		      </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >订购数量：</td>
				  <td  class="txtleft" >
				  <?php echo ($ordersinfo["oddt_qty"]); echo ($ordersinfo["oddt_prounits"]); echo ($ordersinfo["oddt_totalqty"]); ?>
		      </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >已发数量：</td>
				  <td  class="txtleft" >
			   ...
			   <tr>     
                  <td height="40"  class="txtright" >产品条码：</td>
				  <td  class="txtleft" >
                  <textarea name="ship_barcode" rows="5" cols="40"></textarea>
				  <br />
				  注:产品条码可以录入多个，每个条码一行，建议每次录入不要超过50个条码
				  <br />
				  <br />
			   ...
			   <tr>     
				  ...
				  <textarea name="ship_remark" rows="2" cols="40"></textarea>
		      </td>
			  </tr>

			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="下一步出货" class="botton"   id="submit" >　　　　　　　<input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
            </td>
			  </tr>
			</table>
</form>
