...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">我应付返利</A></div>
<div class="nav_r"></div>
</div>
...
<thead><tr>
<th  width="15%" style="text-align:left"><span>提现代理</span></th>
<th  width="15%"   ><span>付款代理</span></th>
<th  width="10%" ><span>发放方式</span></th>
<th  width="10%" ><span>金额</span></th>
<th  width="15%" ><span>申请时间</span></th>
<th  width="15%"  ><span>处理时间</span></th>
...
<td class="data"><span><?php echo ($item["rc_str"]); ?></span></td>
<td class="data"><span><?php echo ($item["rc_moneystr"]); ?></span></td>
<td class="data"><span><?php echo (date('Y-m-d H:i:s',$item["rc_addtime"])); ?></span></td>
<td class="data"><span><?php if(($item["rc_dealtime"] != '') AND ($item["rc_dealtime"] != '0') ): echo (date('Y-m-d H:i:s',$item["rc_dealtime"])); endif; ?></span></td>
<td class="data"><span><?php echo ($item["rc_statestr"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Fanli/recashdetail?rc_id='.$item['rc_id'].'');?>">详细</a> <a href="<?php echo U('Mp/Fanli/recashdeal?rc_id='.$item['rc_id'].'');?>">处理</a></span></td>
