...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
				  ...
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_name"]); ?> </td>
			  </tr>
			    <tr>     
                  <td height="40"   class="txtright" >级别：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_level"]); ?> </td>
			  </tr>
			  <?php if(($dltinfo["dlt_fanli1"] != '') AND ($dltinfo["dlt_fanli1"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli1"]); ?> 元 </td>
			  </tr><?php endif; ?>
			  <?php if(($dltinfo["dlt_fanli2"] != '') AND ($dltinfo["dlt_fanli2"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利2：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli2"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_fanli3"] != '') AND ($dltinfo["dlt_fanli3"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利3：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli3"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_fanli4"] != '') AND ($dltinfo["dlt_fanli4"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利4：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli4"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_fanli5"] != '') AND ($dltinfo["dlt_fanli5"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利5：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli5"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_fanli6"] != '') AND ($dltinfo["dlt_fanli6"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利6：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli6"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_fanli7"] != '') AND ($dltinfo["dlt_fanli7"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利7：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli7"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_fanli8"] != '') AND ($dltinfo["dlt_fanli8"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利8：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli8"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_fanli9"] != '') AND ($dltinfo["dlt_fanli9"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利9：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli9"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_fanli10"] != '') AND ($dltinfo["dlt_fanli10"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >推荐返利10：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_fanli10"]); ?>  元</td>
			  </tr><?php endif; ?>
			  <?php if(($dltinfo["dlt_firstquota"] != '') AND ($dltinfo["dlt_firstquota"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >首次订单最低金额：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_firstquota"]); ?>  元</td>
			  </tr><?php endif; ?>
			   <?php if(($dltinfo["dlt_minnum"] != '') AND ($dltinfo["dlt_minnum"] > '0') ): ?><tr>     
                  <td height="40"   class="txtright" >补货订单最低金额：</td>
				  <td class="txtleft" ><?php echo ($dltinfo["dlt_minnum"]); ?>  元</td>
			  </tr><?php endif; ?>
			  
			  
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  ><input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
            </td>
			  </tr>
			</table>
