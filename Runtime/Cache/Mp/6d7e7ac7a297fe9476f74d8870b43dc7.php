...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Jfmobi/basic/action/zhengce');?>">代理政策</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Jfmobi/edit_save/action/zhengce');?>"   method="post" name="fmmm"  >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
     <tr>     
              ...
              <tr>     
                  <td height="40"   width="25%" class="txtright"  style="font-size:14px; font-weight:bold; padding-top:20px" >编辑代理政策:</td>
				  <td width="75%" class="txtleft" ></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" > </td>
				  <td  class="txtleft" >
				  <textarea name="econtent" id="econtent"  style="width:640px;height:500px;visibility:hidden;" ><?php echo (htmlspecialchars($basicinfo["bas_ppzc"])); ?></textarea>
				  </td>
			  </tr>
			  <tr>  <td height="60" ></td>
              <td  class="txtleft"  >
