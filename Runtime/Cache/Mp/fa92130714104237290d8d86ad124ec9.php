			 ...
			 <?php if($qypurview["90002"] == '90002'): if(!empty($dealerinfo["dl_openid"])): ?><tr>     
			  ...
			  <tr>     
			   ...
			   <tr>     
				  ...
				  <?php if(($dealerinfo["dl_idcardpic_str"]) != ""): ?><a href="/famaotang/Public/uploads/dealer/<?php echo ($dealerinfo["dl_idcardpic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_idcardpic_str"]); ?></a><?php endif; ?>
