...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Index/updatepwd');?>">修改密码</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Index/updatepwd_save');?>"   method="post" name="fmmm"  >
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >旧密码：</td>
				  <td class="txtleft" ><input    type="password" size="25" maxlength="25"  name="old_pwd"  class="input"  value=""  >  * </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >新密码：</td>
				  <td  class="txtleft" ><input type="password" size="25" maxlength="25"  name="pwd1" class="input" value="" >  * </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >确认新密码：</td>
				  <td  class="txtleft" ><input type="password" size="25" maxlength="25"  name="pwd2" class="input" value="" >  * </td>
			  </tr>
