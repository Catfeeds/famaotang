...
return array(
	...
	'DEFAULT_MODULE' => 'Famaotang',
    'URL_HTML_SUFFIX' =>  '',  // URL伪静态后缀设置
	'DB_TYPE'  => 'mysql', // 数据库类型
	'DB_HOST'  => '127.0.0.1', // 服务器地址
    'DB_NAME'  => 'famaotangdb', // 数据库名
    'DB_USER'  => 'root', // 用户名
    'DB_PWD'  => 'root', // 密码
    'DB_PORT'  => 3306, // 端口
    'DB_PREFIX' => 'fw_', // 数据库表前缀缀
    'SESSION_OPTIONS'=>array('type'=> 'db', 'expire'=>360000), //session采用数据库保存 //session过期时间，如果不设就是php.ini中设置的默认值
	...
	'FANLI_SHOUXUFEI'  => 0, // 手续费百分比0.1-10%
    'REGIONAL_COSTS' => 2, // 区域服务费
    'LOW_HIGH' =>0.10, // 低级别直推高级别按高级别所需款项的10%返利
    'C_MONEY' =>0.40, // c补货人
    'B_MONEY' =>0.40, // b直推人
    'A_MONEY' =>0.20, // a推荐人
